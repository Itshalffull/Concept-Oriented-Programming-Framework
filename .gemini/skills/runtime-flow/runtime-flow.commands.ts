...
export async function handleRuntimeFlowSkill(
  command: string,
...
export const runtimeFlowSkillCommands = ['correlate', 'findByAction', 'findBySync', 'findByVariant', 'findFailures', 'compareToStatic', 'sourceLocations', 'get'];
