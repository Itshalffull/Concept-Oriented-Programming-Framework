...
export async function handleThemeImplementationEntitySkill(
  command: string,
...
export const themeImplementationEntitySkillCommands = ['register', 'get', 'getByFile', 'findByTheme', 'findByPlatform', 'resolveToken', 'diffFromSpec'];
