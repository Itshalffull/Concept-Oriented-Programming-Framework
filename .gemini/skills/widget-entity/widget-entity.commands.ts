...
export async function handleWidgetEntitySkill(
  command: string,
...
export const widgetEntitySkillCommands = ['register', 'get', 'findByAffordance', 'findComposing', 'findComposedBy', 'generatedComponents', 'accessibilityAudit', 'traceToConcept'];
