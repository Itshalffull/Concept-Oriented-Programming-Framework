...
export async function handleDependenceGraphSkill(
  command: string,
...
export const dependenceGraphSkillCommands = ['compute', 'queryDependents', 'queryDependencies', 'sliceForward', 'sliceBackward', 'impactAnalysis', 'get'];
