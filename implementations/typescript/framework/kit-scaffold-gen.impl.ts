// ============================================================
// KitScaffoldGen — Kit manifest (kit.yaml) scaffold generator
//
// Generates a kit.yaml manifest and directory structure for a
// new COPF kit from provided inputs: name, description, concept
  ...
  async generate(input: Record<string, unknown>, _storage: ConceptStorage) {
    ...
    try {
      ...
      const files: { path: string; content: string }[] = [
        { path: `${name}/kit.yaml`, content: kitYaml },
      ];
