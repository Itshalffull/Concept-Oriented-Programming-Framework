// ============================================================
// OpenAPI Target Provider — Interface Kit
//
...
function assembleOpenApiDocument(
  ...
  const projectName = (manifestYaml as Record<string, unknown>).name as string || 'COPF API';
  ...
  // --- Header ---
  lines.push('# Auto-generated by COPF Interface Kit — OpenAPI target');
  ...
  lines.push(`  description: OpenAPI specification generated from COPF concept definitions`);
  lines.push('');
