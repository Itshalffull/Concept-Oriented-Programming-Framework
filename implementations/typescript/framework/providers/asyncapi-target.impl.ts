...
function assembleAsyncApiDocument(
  ...
  const projectName = (manifestYaml as Record<string, unknown>).name as string || 'COPF Events';
  ...
  // --- Header ---
  lines.push('# Auto-generated by COPF Interface Kit — AsyncAPI target');
  ...
  lines.push(`  description: AsyncAPI specification generated from COPF concept definitions`);
  lines.push('');
