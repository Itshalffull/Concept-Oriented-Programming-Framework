// ============================================================
// Swift SDK Target Provider — Interface Kit
//
...
export const swiftSdkTargetHandler: ConceptHandler = {
  ...
  async generate(
    ...
    const packageName = (config.packageName as string) || 'COPFClient';
