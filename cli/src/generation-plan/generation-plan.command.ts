...
generationPlanCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef generation-plan status  # Show current run status')
  .action(async (opts) => {
...
generationPlanCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef generation-plan summary  # Show run summary')
  .action(async (opts) => {
...
generationPlanCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef generation-plan history --limit 5  # Show last 5 runs')
  .addHelpText('after', '  clef generation-plan history  # Show last 10 runs')
  .action(async (opts) => {
