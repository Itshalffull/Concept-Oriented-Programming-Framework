...
scoreApiCommand
  .command('list-files')
  .description('List all files in the project matching a glob pattern . 
 ...
 config , test , doc ) , and file size . Use * for all files .')
  ...
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'listFiles', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-file-tree')
  .description('Get a hierarchical tree view of the project starting at 
 ...
 display in chat or tool output .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getFileTree', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-file-content')
  .description('Read a file s content along with its detected language 
 and the names of top level definitions it contains .')
  .requiredOption('--path <path>', 'Path')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getFileContent', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-definitions')
  .description('Extract all definition units from a file functions , 
 ...
 number , and the source span .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getDefinitions', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('match-pattern')
  .description('Run a structural pattern query ( tree sitter query syntax ) 
 ...
 locations with surrounding context .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'matchPattern', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('find-symbol')
  .description('Find all symbols matching the given name . Returns the 
 symbol kind ( function , type , concept , action , field , etc . ) , 
 defining file , line number , and enclosing scope .')
  .requiredOption('--name <name>', 'Name')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'findSymbol', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
...
scoreApiCommand
 ...
 import , type use ) .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getReferences', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-scope')
  .description('Get the scope at a specific file location . Returns the 
 ...
 parent scope if any .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getScope', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-relationships')
  .description('Get typed relationships involving a symbol implements , 
 extends , overrides , calls , imports , depends on , etc .')
  .requiredOption('--symbol <symbol>', 'Symbol')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getRelationships', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('list-concepts')
  .description('List all concepts in the project with their purpose , 
 ...
 Clef application s architecture .')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'listConcepts', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-concept')
  .description('Get complete details of a concept its purpose , type 
 ...
 source file .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getConcept', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-action')
  .description('Get full details of a concept action parameters with 
 ...
 action description .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getAction', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('list-syncs')
  .description('List all sync rules in the project with their annotation 
 ( eager , eventual , local ) , trigger patterns , effect actions , 
 and source file .')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'listSyncs', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-sync')
  .description('Get full details of a sync rule the when clause with 
 ...
 invoked concept action bindings .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getSync', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-flow')
  .description('Trace the static flow graph starting from a concept 
 ...
 understanding side effects and cross concept coordination .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getFlow', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-handler')
  .description('Get the handler implementation for a concept in a given 
 ...
 dependency list , and storage collection usage .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getHandler', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-action-source')
  .description('Get the source code of a specific action method in the 
 ...
 file location .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getActionSource', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('list-handlers')
  .description('List all registered handlers with their concept , language , 
 source file , number of implemented actions , and line count .')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'listHandlers', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('implementation-gaps')
  .description('Find all concept actions that are declared in specs but 
...
scoreApiCommand
  ...
  .description('Parse a stack trace and resolve each frame to handler 
...
scoreApiCommand
  ...
  .description('Get the generated widget implementation for a given 
 ...
 and props interface .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getWidgetImpl', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-theme-impl')
  .description('Get the generated theme implementation for a given 
 platform . Returns source file and token count .')
  .requiredOption('--theme <theme>', 'Theme')
  .requiredOption('--platform <platform>', 'Platform')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getThemeImpl', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-deployment')
  .description('Get a deployment manifest s topology runtimes , concept 
 assignments , and transport storage bindings .')
  .requiredOption('--name <name>', 'Name')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getDeployment', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
...
scoreApiCommand
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getDeploymentTopology', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
...
scoreApiCommand
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getDeploymentHealth', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
...
scoreApiCommand
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'listSuites', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
...
scoreApiCommand
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getSuite', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
...
scoreApiCommand
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'listInterfaces', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
...
scoreApiCommand
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getEndpoints', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('trace-endpoint')
  .description('Trace an API endpoint back to the concept , action , and 
 handler that implements it .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'traceEndpoint', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-dependencies')
  .description('Get direct and transitive dependencies of a symbol . 
...
scoreApiCommand
  ...
  .description('Get direct and transitive dependents of a symbol . 
 Shows what depends on this symbol ( reverse dependencies ) . 
 Useful for impact analysis .')
  .requiredOption('--symbol <symbol>', 'Symbol')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getDependents', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-impact')
  .description('Analyze the impact of changing a file . Returns directly 
 ...
 generated from , etc . ) .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getImpact', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('get-data-flow')
  .description('Find data flow paths between two symbols . Shows how data 
 ...
 Useful for understanding action chains and sync propagation .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'getDataFlow', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('search')
  .description('Search the project using natural language . Combines 
 ...
 matches with relevance score and context snippet .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'search', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('explain')
  .description('Generate a natural language explanation of a symbol 
 ...
 in a response .')
  ...
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'explain', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });

scoreApiCommand
  .command('status')
  .description('Get the current status of the Score index . Returns 
...
scoreApiCommand
  .command('reindex')
  .description('Force a full reindex of the project . Parses all files , 
 ...
 counts and duration in milliseconds .')
  .option('--json', 'Output as JSON')
  .action(async (opts) => {
    const result = await globalThis.kernel.handleRequest({ method: 'reindex', ...opts });
    console.log(opts.json ? JSON.stringify(result) : result);
  });
