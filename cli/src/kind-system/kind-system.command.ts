...
kindSystemCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef kind-system route --from ConceptDSL --to TypeScriptFiles  # Route from source to TypeScript')
  .action(async (opts) => {
...
kindSystemCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef kind-system dependents ConceptManifest  # What depends on ConceptManifest?')
  .action(async (opts) => {
...
kindSystemCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef kind-system producers TypeScriptFiles  # What produces TypeScriptFiles?')
  .action(async (opts) => {
...
kindSystemCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef kind-system consumers ConceptManifest  # What consumes ConceptManifest?')
  .action(async (opts) => {
...
kindSystemCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef kind-system graph  # Display kind graph')
  .action(async (opts) => {
