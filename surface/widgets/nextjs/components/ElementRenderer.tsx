...
// ============================================================
// ElementRenderer — Next.js client component that, given an
// ElementConfig, renders the appropriate HTML input/select/
// button/etc with proper ARIA attributes. Recursive for
// group/container elements that have children.
//
...
//
// 'use client' required for onChange/onClick event handlers.
