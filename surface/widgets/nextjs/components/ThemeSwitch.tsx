...
// ============================================================
// ThemeSwitch — Next.js component to toggle between Clef
// Surface themes.
//
...
export interface ThemeSwitchProps {
  ...
  readonly onActivate?: (theme: ThemeConfig) => void;
  /** Called when the user deactivates a theme. */
  readonly onDeactivate?: (theme: ThemeConfig) => void;
  /**
   * Rendering mode.
   ...
   * @default "radio"
   */
  readonly mode?: 'radio' | 'toggle' | 'buttons';
