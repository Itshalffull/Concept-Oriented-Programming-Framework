...
export interface SegmentedControlResult { element: HTMLElement; dispose: () => void; }

export function SegmentedControl(props: SegmentedControlProps): SegmentedControlResult {
