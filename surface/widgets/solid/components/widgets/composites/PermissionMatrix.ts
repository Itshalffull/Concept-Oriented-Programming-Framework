...
export interface PermissionMatrixResult { element: HTMLElement; dispose: () => void; }

export function PermissionMatrix(props: PermissionMatrixProps): PermissionMatrixResult {
