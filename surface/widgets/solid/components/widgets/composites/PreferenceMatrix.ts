...
export interface PreferenceMatrixResult { element: HTMLElement; dispose: () => void; }

export function PreferenceMatrix(props: PreferenceMatrixProps): PreferenceMatrixResult {
