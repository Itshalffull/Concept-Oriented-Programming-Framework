...
export interface NotificationCenterResult { element: HTMLElement; dispose: () => void; }

export function NotificationCenter(props: NotificationCenterProps): NotificationCenterResult {
