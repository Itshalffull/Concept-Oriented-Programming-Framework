...
export interface TooltipResult { element: HTMLElement; dispose: () => void; }

export function Tooltip(props: TooltipProps): TooltipResult {
  ...
  trigger.addEventListener('pointerenter', () => setState('visible'));
  trigger.addEventListener('pointerleave', () => setState('hidden'));
  trigger.addEventListener('focus', () => setState('visible'));
  trigger.addEventListener('blur', () => setState('hidden'));
