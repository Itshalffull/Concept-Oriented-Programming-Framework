...
export interface ToastManagerResult { element: HTMLElement; dispose: () => void; }

export function ToastManager(props: ToastManagerProps): ToastManagerResult {
  ...
  root.setAttribute('data-placement', (props.placement as string) || 'bottom-right');
