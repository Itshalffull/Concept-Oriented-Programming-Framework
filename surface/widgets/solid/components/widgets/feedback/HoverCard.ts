...
export interface HoverCardResult { element: HTMLElement; dispose: () => void; }

export function HoverCard(props: HoverCardProps): HoverCardResult {
  ...
  trigger.addEventListener('pointerenter', () => { setState('open'); root.setAttribute('data-state', 'open'); });
  trigger.addEventListener('pointerleave', () => { setState('hidden'); root.setAttribute('data-state', 'hidden'); });
