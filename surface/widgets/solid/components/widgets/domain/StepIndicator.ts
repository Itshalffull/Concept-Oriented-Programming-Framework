...
export interface StepIndicatorResult { element: HTMLElement; dispose: () => void; }

export function StepIndicator(props: StepIndicatorProps): StepIndicatorResult {
  ...
  root.setAttribute('aria-label', 'Step indicator');
