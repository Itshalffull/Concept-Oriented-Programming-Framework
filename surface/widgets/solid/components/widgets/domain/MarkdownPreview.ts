...
export interface MarkdownPreviewResult { element: HTMLElement; dispose: () => void; }

export function MarkdownPreview(props: MarkdownPreviewProps): MarkdownPreviewResult {
  ...
  root.setAttribute('aria-label', 'Markdown preview');
