...
export interface GraphViewResult { element: HTMLElement; dispose: () => void; }

export function GraphView(props: GraphViewProps): GraphViewResult {
  ...
  root.setAttribute('aria-label', 'Graph view');
