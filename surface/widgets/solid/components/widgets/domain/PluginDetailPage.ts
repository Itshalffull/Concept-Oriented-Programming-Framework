...
export interface PluginDetailPageResult { element: HTMLElement; dispose: () => void; }

export function PluginDetailPage(props: PluginDetailPageProps): PluginDetailPageResult {
