...
export interface StateMachineDiagramResult { element: HTMLElement; dispose: () => void; }

export function StateMachineDiagram(props: StateMachineDiagramProps): StateMachineDiagramResult {
  ...
  root.setAttribute('aria-label', 'State machine diagram');
