...
export interface CanvasConnectorResult { element: HTMLElement; dispose: () => void; }

export function CanvasConnector(props: CanvasConnectorProps): CanvasConnectorResult {
