...
export interface ColorLabelPickerResult { element: HTMLElement; dispose: () => void; }

export function ColorLabelPicker(props: ColorLabelPickerProps): ColorLabelPickerResult {
