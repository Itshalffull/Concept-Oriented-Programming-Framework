...
export interface CanvasResult { element: HTMLElement; dispose: () => void; }

export function Canvas(props: CanvasProps): CanvasResult {
  ...
  root.setAttribute('aria-label', 'Canvas');
  root.tabIndex = 0;
