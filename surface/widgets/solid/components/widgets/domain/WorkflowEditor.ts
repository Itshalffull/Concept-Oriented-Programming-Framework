...
export interface WorkflowEditorResult { element: HTMLElement; dispose: () => void; }

export function WorkflowEditor(props: WorkflowEditorProps): WorkflowEditorResult {
  ...
  root.setAttribute('aria-label', 'Workflow editor');
