...
export interface ConditionBuilderResult { element: HTMLElement; dispose: () => void; }

export function ConditionBuilder(props: ConditionBuilderProps): ConditionBuilderResult {
