...
export interface AutomationBuilderResult { element: HTMLElement; dispose: () => void; }

export function AutomationBuilder(props: AutomationBuilderProps): AutomationBuilderResult {
  ...
  root.setAttribute('aria-label', 'Automation builder');
