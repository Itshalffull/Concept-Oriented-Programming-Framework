...
// --- Primitives ---
import { createAvatar } from '../svelte/components/widgets/primitives/Avatar.ts';
import { createButton } from '../svelte/components/widgets/primitives/Button.ts';
import { createCheckbox } from '../svelte/components/widgets/primitives/Checkbox.ts';
import { createChip } from '../svelte/components/widgets/primitives/Chip.ts';
import { createFocusTrap } from '../svelte/components/widgets/primitives/FocusTrap.ts';
import { createIcon } from '../svelte/components/widgets/primitives/Icon.ts';
import { createLabel } from '../svelte/components/widgets/primitives/Label.ts';
import { createPortal } from '../svelte/components/widgets/primitives/Portal.ts';
import { createPresence } from '../svelte/components/widgets/primitives/Presence.ts';
import { createScrollLock } from '../svelte/components/widgets/primitives/ScrollLock.ts';
import { createSeparator } from '../svelte/components/widgets/primitives/Separator.ts';
import { createSpinner } from '../svelte/components/widgets/primitives/Spinner.ts';
import { createTextInput } from '../svelte/components/widgets/primitives/TextInput.ts';
import { createVisuallyHidden } from '../svelte/components/widgets/primitives/VisuallyHidden.ts';

// --- Form Controls ---
import { createBadge } from '../svelte/components/widgets/form-controls/Badge.ts';
import { createCheckboxGroup } from '../svelte/components/widgets/form-controls/CheckboxGroup.ts';
import { createChipInput } from '../svelte/components/widgets/form-controls/ChipInput.ts';
import { createCombobox } from '../svelte/components/widgets/form-controls/Combobox.ts';
import { createComboboxMulti } from '../svelte/components/widgets/form-controls/ComboboxMulti.ts';
import { createMultiSelect } from '../svelte/components/widgets/form-controls/MultiSelect.ts';
import { createNumberInput } from '../svelte/components/widgets/form-controls/NumberInput.ts';
import { createProgressBar } from '../svelte/components/widgets/form-controls/ProgressBar.ts';
import { createRadioCard } from '../svelte/components/widgets/form-controls/RadioCard.ts';
import { createRadioGroup } from '../svelte/components/widgets/form-controls/RadioGroup.ts';
import { createSegmentedControl } from '../svelte/components/widgets/form-controls/SegmentedControl.ts';
import { createSelect } from '../svelte/components/widgets/form-controls/Select.ts';
import { createSlider } from '../svelte/components/widgets/form-controls/Slider.ts';
import { createStepper } from '../svelte/components/widgets/form-controls/Stepper.ts';
import { createTextarea } from '../svelte/components/widgets/form-controls/Textarea.ts';
import { createToggleSwitch } from '../svelte/components/widgets/form-controls/ToggleSwitch.ts';

// --- Feedback ---
import { createAlert } from '../svelte/components/widgets/feedback/Alert.ts';
import { createAlertDialog } from '../svelte/components/widgets/feedback/AlertDialog.ts';
import { createContextMenu } from '../svelte/components/widgets/feedback/ContextMenu.ts';
import { createDialog } from '../svelte/components/widgets/feedback/Dialog.ts';
import { createDrawer } from '../svelte/components/widgets/feedback/Drawer.ts';
import { createHoverCard } from '../svelte/components/widgets/feedback/HoverCard.ts';
import { createPopover } from '../svelte/components/widgets/feedback/Popover.ts';
import { createToast } from '../svelte/components/widgets/feedback/Toast.ts';
import { createToastManager } from '../svelte/components/widgets/feedback/ToastManager.ts';
import { createTooltip } from '../svelte/components/widgets/feedback/Tooltip.ts';

// --- Navigation ---
import { createAccordion } from '../svelte/components/widgets/navigation/Accordion.ts';
import { createBreadcrumb } from '../svelte/components/widgets/navigation/Breadcrumb.ts';
import { createCommandPalette } from '../svelte/components/widgets/navigation/CommandPalette.ts';
import { createDisclosure } from '../svelte/components/widgets/navigation/Disclosure.ts';
import { createFieldset } from '../svelte/components/widgets/navigation/Fieldset.ts';
import { createFloatingToolbar } from '../svelte/components/widgets/navigation/FloatingToolbar.ts';
import { createForm } from '../svelte/components/widgets/navigation/Form.ts';
import { createMenu } from '../svelte/components/widgets/navigation/Menu.ts';
import { createNavigationMenu } from '../svelte/components/widgets/navigation/NavigationMenu.ts';
import { createPagination } from '../svelte/components/widgets/navigation/Pagination.ts';
import { createSidebar } from '../svelte/components/widgets/navigation/Sidebar.ts';
import { createSplitter } from '../svelte/components/widgets/navigation/Splitter.ts';
import { createTabs } from '../svelte/components/widgets/navigation/Tabs.ts';
import { createToolbar } from '../svelte/components/widgets/navigation/Toolbar.ts';

// --- Data Display ---
import { createCalendarView } from '../svelte/components/widgets/data-display/CalendarView.ts';
import { createCard } from '../svelte/components/widgets/data-display/Card.ts';
import { createCardGrid } from '../svelte/components/widgets/data-display/CardGrid.ts';
import { createChart } from '../svelte/components/widgets/data-display/Chart.ts';
import { createDataList } from '../svelte/components/widgets/data-display/DataList.ts';
import { createDataTable } from '../svelte/components/widgets/data-display/DataTable.ts';
import { createEmptyState } from '../svelte/components/widgets/data-display/EmptyState.ts';
import { createGauge } from '../svelte/components/widgets/data-display/Gauge.ts';
import { createKanbanBoard } from '../svelte/components/widgets/data-display/KanbanBoard.ts';
import { createList } from '../svelte/components/widgets/data-display/List.ts';
import { createNotificationItem } from '../svelte/components/widgets/data-display/NotificationItem.ts';
import { createSkeleton } from '../svelte/components/widgets/data-display/Skeleton.ts';
import { createStatCard } from '../svelte/components/widgets/data-display/StatCard.ts';
import { createTimeline } from '../svelte/components/widgets/data-display/Timeline.ts';
import { createViewToggle } from '../svelte/components/widgets/data-display/ViewToggle.ts';

// --- Composites ---
import { createBacklinkPanel } from '../svelte/components/widgets/composites/BacklinkPanel.ts';
import { createCacheDashboard } from '../svelte/components/widgets/composites/CacheDashboard.ts';
import { createDiffViewer } from '../svelte/components/widgets/composites/DiffViewer.ts';
import { createFacetedSearch } from '../svelte/components/widgets/composites/FacetedSearch.ts';
import { createFileBrowser } from '../svelte/components/widgets/composites/FileBrowser.ts';
import { createFilterBuilder } from '../svelte/components/widgets/composites/FilterBuilder.ts';
import { createMasterDetail } from '../svelte/components/widgets/composites/MasterDetail.ts';
import { createNotificationCenter } from '../svelte/components/widgets/composites/NotificationCenter.ts';
import { createPermissionMatrix } from '../svelte/components/widgets/composites/PermissionMatrix.ts';
import { createPluginCard } from '../svelte/components/widgets/composites/PluginCard.ts';
import { createPreferenceMatrix } from '../svelte/components/widgets/composites/PreferenceMatrix.ts';
import { createPropertyPanel } from '../svelte/components/widgets/composites/PropertyPanel.ts';
import { createQueueDashboard } from '../svelte/components/widgets/composites/QueueDashboard.ts';
import { createSchemaEditor } from '../svelte/components/widgets/composites/SchemaEditor.ts';
import { createSortBuilder } from '../svelte/components/widgets/composites/SortBuilder.ts';
import { createViewSwitcher } from '../svelte/components/widgets/composites/ViewSwitcher.ts';

// --- Complex Inputs ---
import { createColorPicker } from '../svelte/components/widgets/complex-inputs/ColorPicker.ts';
import { createDatePicker } from '../svelte/components/widgets/complex-inputs/DatePicker.ts';
import { createDateRangePicker } from '../svelte/components/widgets/complex-inputs/DateRangePicker.ts';
import { createFileUpload } from '../svelte/components/widgets/complex-inputs/FileUpload.ts';
import { createFormulaEditor } from '../svelte/components/widgets/complex-inputs/FormulaEditor.ts';
import { createMentionInput } from '../svelte/components/widgets/complex-inputs/MentionInput.ts';
import { createPinInput } from '../svelte/components/widgets/complex-inputs/PinInput.ts';
import { createRangeSlider } from '../svelte/components/widgets/complex-inputs/RangeSlider.ts';
import { createRating } from '../svelte/components/widgets/complex-inputs/Rating.ts';
import { createRichTextEditor } from '../svelte/components/widgets/complex-inputs/RichTextEditor.ts';
import { createSignaturePad } from '../svelte/components/widgets/complex-inputs/SignaturePad.ts';
import { createTreeSelect } from '../svelte/components/widgets/complex-inputs/TreeSelect.ts';

// --- Domain ---
import { createAutomationBuilder } from '../svelte/components/widgets/domain/AutomationBuilder.ts';
import { createBlockEditor } from '../svelte/components/widgets/domain/BlockEditor.ts';
import { createCanvas } from '../svelte/components/widgets/domain/Canvas.ts';
import { createCanvasConnector } from '../svelte/components/widgets/domain/CanvasConnector.ts';
import { createCanvasNode } from '../svelte/components/widgets/domain/CanvasNode.ts';
import { createCodeBlock } from '../svelte/components/widgets/domain/CodeBlock.ts';
import { createColorLabelPicker } from '../svelte/components/widgets/domain/ColorLabelPicker.ts';
import { createConditionBuilder } from '../svelte/components/widgets/domain/ConditionBuilder.ts';
import { createCronEditor } from '../svelte/components/widgets/domain/CronEditor.ts';
import { createDragHandle } from '../svelte/components/widgets/domain/DragHandle.ts';
import { createFieldMapper } from '../svelte/components/widgets/domain/FieldMapper.ts';
import { createGraphView } from '../svelte/components/widgets/domain/GraphView.ts';
import { createImageGallery } from '../svelte/components/widgets/domain/ImageGallery.ts';
import { createInlineEdit } from '../svelte/components/widgets/domain/InlineEdit.ts';
import { createMarkdownPreview } from '../svelte/components/widgets/domain/MarkdownPreview.ts';
import { createMinimap } from '../svelte/components/widgets/domain/Minimap.ts';
import { createOutliner } from '../svelte/components/widgets/domain/Outliner.ts';
import { createPluginDetailPage } from '../svelte/components/widgets/domain/PluginDetailPage.ts';
import { createPolicyEditor } from '../svelte/components/widgets/domain/PolicyEditor.ts';
import { createSlashMenu } from '../svelte/components/widgets/domain/SlashMenu.ts';
import { createStateMachineDiagram } from '../svelte/components/widgets/domain/StateMachineDiagram.ts';
import { createStepIndicator } from '../svelte/components/widgets/domain/StepIndicator.ts';
import { createTokenInput } from '../svelte/components/widgets/domain/TokenInput.ts';
import { createWorkflowEditor } from '../svelte/components/widgets/domain/WorkflowEditor.ts';
import { createWorkflowNode } from '../svelte/components/widgets/domain/WorkflowNode.ts';
