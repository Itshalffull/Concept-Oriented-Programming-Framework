...
| Command | Purpose |
|---------|---------|
| `clef toolchain list` | Show all resolved toolchains |
| `clef toolchain resolve swift` | Resolve Swift toolchain |
| `clef toolchain validate` | Re-validate all toolchains |
