...
export async function handleRetentionPolicySkill(
  command: string,
...
export const retentionPolicySkillCommands = ['setRetention', 'applyHold', 'releaseHold', 'checkDisposition', 'dispose', 'auditLog'];
