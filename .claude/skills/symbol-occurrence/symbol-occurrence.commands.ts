...
export async function handleSymbolOccurrenceSkill(
  command: string,
...
export const symbolOccurrenceSkillCommands = ['record', 'findDefinitions', 'findReferences', 'findAtPosition', 'findInFile'];
