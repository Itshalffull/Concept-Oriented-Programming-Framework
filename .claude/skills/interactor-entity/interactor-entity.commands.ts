...
export async function handleInteractorEntitySkill(
  command: string,
...
export const interactorEntitySkillCommands = ['register', 'findByCategory', 'matchingWidgets', 'classifiedFields', 'coverageReport', 'get'];
