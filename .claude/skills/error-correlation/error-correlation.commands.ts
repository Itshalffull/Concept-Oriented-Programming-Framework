...
export async function handleErrorCorrelationSkill(
  command: string,
...
export const errorCorrelationSkillCommands = ['record', 'findByEntity', 'findByKind', 'errorHotspots', 'rootCause', 'get'];
