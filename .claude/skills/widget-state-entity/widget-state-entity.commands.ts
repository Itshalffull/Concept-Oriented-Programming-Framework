...
export async function handleWidgetStateEntitySkill(
  command: string,
...
export const widgetStateEntitySkillCommands = ['register', 'findByWidget', 'reachableFrom', 'unreachableStates', 'traceEvent', 'get'];
