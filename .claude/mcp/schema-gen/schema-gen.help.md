# schema_gen — MCP Tool Guide

Generate a ConceptManifest from **{input}** that provides typed action signatures, state schemas, and invariant test values for code generation.
