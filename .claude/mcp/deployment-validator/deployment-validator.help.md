# deployment_validator — MCP Tool Guide

Validate deployment manifest **{input}** against compiled concepts and syncs, checking runtime mappings, engine assignments, and transport configuration.
