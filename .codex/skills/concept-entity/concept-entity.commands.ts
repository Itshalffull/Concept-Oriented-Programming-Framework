...
export async function handleConceptEntitySkill(
  command: string,
...
export const conceptEntitySkillCommands = ['register', 'get', 'findByCapability', 'findBySuite', 'generatedArtifacts', 'participatingSyncs', 'checkCompatibility'];
