...
export async function handleSyncEntitySkill(
  command: string,
...
export const syncEntitySkillCommands = ['register', 'findByConcept', 'findTriggerableBy', 'chainFrom', 'findDeadEnds', 'findOrphanVariants', 'get'];
