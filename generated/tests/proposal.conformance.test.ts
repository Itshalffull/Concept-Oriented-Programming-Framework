...
describe('Proposal functional handler', () => {
  ...
  describe('sponsor', () => {
    ...
    it('covers all declared variants', () => {
      ...
      if (!program?.instructions) return; // skip non-StorageProgram handlers
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('sponsored');
      expect(variants).toContain('not_pending');
    });
  ...
  describe('activate', () => {
    ...
    it('covers all declared variants', () => {
      ...
      if (!program?.instructions) return; // skip non-StorageProgram handlers
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('activated');
    });
  ...
  describe('advance', () => {
    ...
    it('covers all declared variants', () => {
      ...
      expect(variants).toContain('invalid_transition');
    });
