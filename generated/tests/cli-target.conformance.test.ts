...
describe('CliTarget functional handler', () => {
  ...
  describe('generate', () => {
    ...
    it('covers all declared variants', () => {
      ...
      expect(variants).toContain('tooManyPositional');
    });
  ...
  describe('validate', () => {
    ...
    it('covers all declared variants', () => {
      ...
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('ok');
      expect(variants).toContain('flagCollision');
    });
        ...
        fc.asyncProperty(
          fc.array(
            fc.oneof(
              ...
              fc.record({ action: fc.constant('listCommands'), input: fc.record({ concept: fc.string({ minLength: 1, maxLength: 20 }) }) }),
            ),
