...
describe('CircuitBreaker functional handler', () => {
  ...
  describe('configure', () => {
    ...
    it('fixture "missing_endpoint" -> exists', async () => {
      ...
      const _fixtureInput = { endpoint: "", failureThreshold: "5", successThreshold: "2", resetTimeoutMs: "30000" } as Record<string, unknown>;
      ...
      const result = await interpret(circuitBreakerHandler.configure({ ..._fixtureInput }), storage);
