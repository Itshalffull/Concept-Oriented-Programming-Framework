...
describe('McpTarget functional handler', () => {
  ...
  describe('generate', () => {
    ...
    it('covers all declared variants', () => {
      ...
      expect(variants).toContain('tooManyTools');
    });
        ...
        fc.asyncProperty(
          fc.array(
            fc.oneof(
              ...
              fc.record({ action: fc.constant('listTools'), input: fc.record({ concept: fc.string({ minLength: 1, maxLength: 20 }) }) }),
            ),
  ...
  describe('action contracts (PBT)', () => {
    it('generate requires: ', async () => {
      const storage = createInMemoryStorage();
      const result = await interpret(mcpTargetHandler.generate({  }), storage);
