...
describe('Validator functional handler', () => {
  ...
  describe('registerConstraint', () => {
    ...
    it('fixture "register_required" -> ok', async () => {
      ...
      const afterResult_validate_email_field = await interpret(validatorHandler.validateField({ validator: "user-form", field: "email", value: "alice@example.com" }), storage);
      ...
      const _pool = Object.assign({}, (afterResult_validate_email_field?.output ?? {}), (afterResult_validate_valid_data?.output ?? {}));
  ...
  describe('addRule', () => {
    ...
    it('fixture "add_email_rule" -> ok', async () => {
      ...
      const _pool = Object.assign({}, (afterResult_validate_email_field?.output ?? {}), (afterResult_validate_valid_data?.output ?? {}), (afterResult_register_required?.output ?? {}));
  ...
  describe('validate', () => {
    ...
    it('fixture "validate_valid_data" -> ok', async () => {
      ...
      const storage = createInMemoryStorage();
      const afterResult_validate_email_field = await interpret(validatorHandler.validateField({ validator: "user-form", field: "email", value: "alice@example.com" }), storage);
      const _pool = Object.assign({}, (afterResult_validate_email_field?.output ?? {}));
