...
describe('SuiteManager functional handler', () => {
  ...
  describe('init', () => {
    it('builds a valid StorageProgram', () => {
      const program = suiteManagerHandler.init({ name: 'test-name' });
    ...
    it('executes successfully', async () => {
      ...
      const result = await interpret(suiteManagerHandler.init({ name: 'test-name' }), storage);
  ...
  describe('validate', () => {
    it('builds a valid StorageProgram', () => {
      const program = suiteManagerHandler.validate({ path: 'test-path' });
      expect(program).toBeDefined();
      expect(program.instructions).toBeDefined();
      expect(Array.isArray(program.instructions)).toBe(true);
      expect(program.instructions.length).toBeGreaterThan(0);
    ...
    it('executes successfully', async () => {
      ...
      const result = await interpret(suiteManagerHandler.validate({ path: 'test-path' }), storage);
      expect(result).toBeDefined();
      expect(result.variant).toBeDefined();
      expect(typeof result.variant).toBe('string');
    });
  ...
  describe('test', () => {
    it('builds a valid StorageProgram', () => {
      const program = suiteManagerHandler.test({ path: 'test-path' });
      expect(program).toBeDefined();
      expect(program.instructions).toBeDefined();
      expect(Array.isArray(program.instructions)).toBe(true);
      expect(program.instructions.length).toBeGreaterThan(0);
    ...
    it('executes successfully', async () => {
      ...
      const result = await interpret(suiteManagerHandler.test({ path: 'test-path' }), storage);
      expect(result).toBeDefined();
      expect(result.variant).toBeDefined();
      expect(typeof result.variant).toBe('string');
    });
  ...
  describe('checkOverrides', () => {
    it('builds a valid StorageProgram', () => {
      const program = suiteManagerHandler.checkOverrides({ path: 'test-path' });
      expect(program).toBeDefined();
      expect(program.instructions).toBeDefined();
      expect(Array.isArray(program.instructions)).toBe(true);
      expect(program.instructions.length).toBeGreaterThan(0);
    ...
    it('covers all declared variants', () => {
      ...
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('ok');
      expect(variants).toContain('invalidOverride');
    });
    ...
    it('executes successfully', async () => {
      ...
      const result = await interpret(suiteManagerHandler.checkOverrides({ path: 'test-path' }), storage);
      expect(result).toBeDefined();
      expect(result.variant).toBeDefined();
      expect(typeof result.variant).toBe('string');
    });
    ...
    it('always: suites have names and paths', async () => {
      await fc.assert(
        fc.asyncProperty(
          fc.array(
            fc.oneof(
              fc.record({ action: fc.constant('init'), input: fc.record({ name: fc.string({ minLength: 1, maxLength: 20 }) }) }),
              fc.record({ action: fc.constant('validate'), input: fc.record({ path: fc.string({ minLength: 1, maxLength: 20 }) }) }),
              fc.record({ action: fc.constant('test'), input: fc.record({ path: fc.string({ minLength: 1, maxLength: 20 }) }) }),
              fc.record({ action: fc.constant('list'), input: fc.record({  }) }),
              fc.record({ action: fc.constant('checkOverrides'), input: fc.record({ path: fc.string({ minLength: 1, maxLength: 20 }) }) }),
            ),
