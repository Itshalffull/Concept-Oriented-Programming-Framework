...
describe('FlakyTest functional handler', () => {
  ...
  describe('record', () => {
    ...
    it('covers all declared variants', () => {
      ...
      expect(variants).toContain('flakyDetected');
    });
  ...
  describe('quarantine', () => {
    ...
    it('covers all declared variants', () => {
      ...
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('ok');
      expect(variants).toContain('alreadyQuarantined');
  ...
  describe('release', () => {
    ...
    it('covers all declared variants', () => {
      ...
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('ok');
      expect(variants).toContain('notQuarantined');
    });
