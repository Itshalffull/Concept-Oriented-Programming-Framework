...
describe('GTKAdapter functional handler', () => {
  ...
  describe('normalize', () => {
    it('builds a valid StorageProgram', () => {
      const program = gTKAdapterHandler.normalize({ adapter: 'test', props: 'test-props' });
    ...
    it('executes without crashing', async () => {
      ...
      try {
        const result = await interpret(gTKAdapterHandler.normalize({ adapter: 'test', props: 'test-props' }), storage);
