...
describe('WatchAdapter functional handler', () => {
  ...
  describe('invariant examples', () => {
    it("normalize then normalize", async () => {
      const storage = createInMemoryStorage();
      const normalizeResult0 = await interpret(watchAdapterHandler.normalize({ adapter: "test-a", props: "{ \"type\": \"navigation\", \"destination\": \"heartRate\" }" }), storage);
      ...
      const thenResult0 = await interpret(watchAdapterHandler.normalize({ adapter: "test-a", props: "" }), storage);
