...
describe('RustSdkTarget functional handler', () => {
  ...
  describe('generate', () => {
    it('builds a valid StorageProgram', () => {
      const program = rustSdkTargetHandler.generate({ projection: 'test-projection', config: 'test-config' });
    ...
    it('executes without crashing', async () => {
      ...
      try {
        const result = await interpret(rustSdkTargetHandler.generate({ projection: 'test-projection', config: 'test-config' }), storage);
