// SuffixArrayIndexProvider Functional Handler Conformance Tests
//
...
import { suffixArrayIndexProviderHandler } from '../../handlers/ts/suffix-array-index-provider.handler.js';
import {
  classifyPurity,
...
describe('SuffixArrayIndexProvider functional handler', () => {
  ...
  describe('register()', () => {
    it('declares concept name', async () => {
      ...
      const program = suffixArrayIndexProviderHandler.register({});
      ...
      expect(name).toBe('SuffixArrayIndexProvider');
    });
  });
