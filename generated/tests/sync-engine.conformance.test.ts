        ...
        fc.asyncProperty(
          fc.array(
            fc.oneof(
              ...
              fc.record({ action: fc.constant('queueSync'), input: fc.record({ sync: fc.string(), bindings: fc.string(), flow: fc.string({ minLength: 1, maxLength: 20 }) }) }),
              fc.record({ action: fc.constant('onAvailabilityChange'), input: fc.record({ conceptUri: fc.string({ minLength: 1, maxLength: 20 }), available: fc.boolean() }) }),
