...
describe('WatchKitAdapter functional handler', () => {
  ...
  describe('invariant examples', () => {
    it("normalize then normalize", async () => {
      const storage = createInMemoryStorage();
      const normalizeResult0 = await interpret(watchKitAdapterHandler.normalize({ adapter: "test-a", props: "{ \"onclick\": \"handler_1\", \"class\": \"btn\" }" }), storage);
      ...
      const thenResult0 = await interpret(watchKitAdapterHandler.normalize({ adapter: "test-a", props: "" }), storage);
