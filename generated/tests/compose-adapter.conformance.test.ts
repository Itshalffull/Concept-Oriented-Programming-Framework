...
describe('ComposeAdapter functional handler', () => {
  ...
  describe('normalize', () => {
    it('builds a valid StorageProgram', () => {
      const program = composeAdapterHandler.normalize({ adapter: 'test', props: 'test-props' });
    ...
    it('executes without crashing', async () => {
      ...
      try {
        const result = await interpret(composeAdapterHandler.normalize({ adapter: 'test', props: 'test-props' }), storage);
