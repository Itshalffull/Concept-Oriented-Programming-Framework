...
describe('VueAdapter functional handler', () => {
  ...
  describe('invariant examples', () => {
    it("normalize succeeds with valid props and fails with empty", async () => {
      const storage = createInMemoryStorage();
      const normalizeResult0 = await interpret(vueAdapterHandler.normalize({ adapter: "test-a", props: "{ \"onclick\": \"handler_1\", \"class\": \"btn\" }" }), storage);
      ...
      const thenResult0 = await interpret(vueAdapterHandler.normalize({ adapter: "test-a", props: "" }), storage);
