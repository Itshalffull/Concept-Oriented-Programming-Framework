...
describe('CloudFormationProvider functional handler', () => {
  ...
  describe('preview', () => {
    ...
    it('covers all declared variants', () => {
      ...
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('ok');
      expect(variants).toContain('changeSetEmpty');
    });
  ...
  describe('apply', () => {
    ...
    it('covers all declared variants', () => {
      ...
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('ok');
      expect(variants).toContain('rollbackComplete');
      expect(variants).toContain('partial');
      expect(variants).toContain('insufficientCapabilities');
    });
  ...
  describe('teardown', () => {
    ...
    it('covers all declared variants', () => {
      ...
      const variants = extractCompletionVariants(program);
      expect(variants).toContain('ok');
      expect(variants).toContain('deletionFailed');
    });
