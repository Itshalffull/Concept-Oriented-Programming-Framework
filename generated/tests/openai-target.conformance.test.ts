...
describe('OpenaiTarget functional handler', () => {
  ...
  describe('validate', () => {
    ...
    it('fixture "validate_valid" -> ok', async () => {
      ...
      const _fixtureInput = { function: "fn-score-001" } as Record<string, unknown>;
  ...
  describe('register()', () => {
    it('declares concept name', async () => {
      ...
      const storage = createInMemoryStorage();
      const program = openaiTargetHandler.register({});
  ...
  describe('action contracts (PBT)', () => {
    it('generate handles empty input: ', async () => {
      if (typeof openaiTargetHandler.generate !== 'function') return;
      const storage = createInMemoryStorage();
      const result = await safeInvoke(async () => await interpret(openaiTargetHandler.generate({  }), storage));
