...
1. **Validate** — `clef kit validate ./kits/my-kit`
2. **Test** — `clef kit test ./kits/my-kit`
3. **Version** — Update `kit.yaml` version field.
4. **Package** — `clef kit pack ./kits/my-kit`
5. **Publish** — `clef kit publish ./kits/my-kit`
...
clef kit publish ./kits/my-kit

# Publish to custom registry
clef kit publish ./kits/my-kit --registry https://my-registry.com
```

## Installing Kits

```bash
clef kit add auth@1.0.0
```
