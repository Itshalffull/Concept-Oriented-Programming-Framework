...
Self-register with PluginRegistry so the scaffolding kit's KindSystem can track InterfaceConfig → InterfaceManifest transformations.
...
### Step 2: Generate Interface Manifest
