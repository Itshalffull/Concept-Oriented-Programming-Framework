...
emitterCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef emitter clean ./generated  # Clean generated directory')
  .action(async (opts) => {
...
emitterCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef emitter manifest ./generated  # List outputs in generated/')
  .action(async (opts) => {
...
emitterCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef emitter trace ./generated/user.types.ts  # Trace provenance of a generated file')
  .action(async (opts) => {
...
emitterCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef emitter audit ./generated  # Audit generated directory')
  .action(async (opts) => {
