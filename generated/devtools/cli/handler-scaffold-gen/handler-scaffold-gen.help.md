# copf handler-scaffold-gen — Help

Use when implementing a concept handler in TypeScript. Generates a .impl.ts handler with register(), typed action methods, input extraction, storage patterns, and a conformance test file.
