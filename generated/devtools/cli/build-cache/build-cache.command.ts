...
buildCacheCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef build-cache invalidate-by-source specs/app/article.concept  # Invalidate after concept change')
  .action(async (opts) => {
...
buildCacheCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef build-cache invalidate-by-kind TypeScriptFiles  # Invalidate all TypeScript generation')
  .action(async (opts) => {
...
buildCacheCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef build-cache invalidate-all  # Full cache reset')
  .action(async (opts) => {
...
buildCacheCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef build-cache status  # View cache status')
  .action(async (opts) => {
...
buildCacheCommand
  ...
  .option('--json', 'Output as JSON')
  .addHelpText('after', '\nExamples:')
  .addHelpText('after', '  clef build-cache stale-steps  # Find stale entries')
  .action(async (opts) => {
