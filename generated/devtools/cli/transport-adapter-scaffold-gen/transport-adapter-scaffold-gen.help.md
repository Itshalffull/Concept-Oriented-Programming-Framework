# copf transport-adapter-scaffold-gen — Help

Use when adding a new transport protocol to a COPF application. Generates a transport adapter with invoke, query, and health methods for the specified protocol.
