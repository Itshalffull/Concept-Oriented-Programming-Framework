# copf storage-adapter-scaffold-gen — Help

Use when adding a new storage backend to a COPF application. Generates a ConceptStorage adapter implementation with put, get, find, del, and delMany methods for the specified backend.
