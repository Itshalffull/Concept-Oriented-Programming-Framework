# copf sync-scaffold-gen — Help

Use when creating a new sync rule to connect concepts. Generates a .sync file with when/where/then clauses from trigger and effect configurations.
