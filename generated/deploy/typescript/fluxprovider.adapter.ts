// generated: fluxprovider.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@clef/runtime";
import type { FluxProviderHandler } from "./fluxprovider.handler";
import type { ConceptStorage } from "@clef/runtime";

export function createFluxProviderLiteAdapter(
  handler: FluxProviderHandler,
