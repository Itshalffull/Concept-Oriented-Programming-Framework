// generated: lambdaruntime.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@copf/runtime";
import type { LambdaRuntimeHandler } from "./lambdaruntime.handler";
import type { ConceptStorage } from "@copf/runtime";

export function createLambdaRuntimeLiteAdapter(
  handler: LambdaRuntimeHandler,
