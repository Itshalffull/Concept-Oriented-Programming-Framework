// generated: awssmprovider.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@clef/runtime";
import type { AwsSmProviderHandler } from "./awssmprovider.handler";
import type { ConceptStorage } from "@clef/runtime";

export function createAwsSmProviderLiteAdapter(
  handler: AwsSmProviderHandler,
