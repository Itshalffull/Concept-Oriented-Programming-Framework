// generated: vaultprovider.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@copf/runtime";
import type { VaultProviderHandler } from "./vaultprovider.handler";
import type { ConceptStorage } from "@copf/runtime";

export function createVaultProviderLiteAdapter(
  handler: VaultProviderHandler,
