// generated: deployplan.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@clef/runtime";
import type { DeployPlanHandler } from "./deployplan.handler";
import type { ConceptStorage } from "@clef/runtime";

export function createDeployPlanLiteAdapter(
  handler: DeployPlanHandler,
