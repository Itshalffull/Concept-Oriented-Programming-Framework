// generated: env_provider/conformance.rs

#[cfg(test)]
mod tests {
    use super::super::handler::EnvProviderHandler;
    use super::super::types::*;
    use crate::storage::create_in_memory_storage;

    #[tokio::test]
    async fn env_provider_invariant_1() {
        ...
        let step1 = handler.fetch(
            FetchInput { name: "DATABASE_URL".to_string() },
            &storage,
        ).await.unwrap();
        match step1 {
