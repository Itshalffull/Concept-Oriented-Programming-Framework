// generated: desktop_adapter/conformance.rs

#[cfg(test)]
mod tests {
    use super::super::handler::DesktopAdapterHandler;
    use super::super::types::*;
    use crate::storage::create_in_memory_storage;

    #[tokio::test]
    async fn desktop_adapter_invariant_1() {
        ...
        // --- AFTER clause ---
        // normalize(adapter: a, props: "{ \"type\": \"navigation\", \"destination\": \"settings\", \"windowConfig\": { \"reuse\": true } }") -> ok(adapter: a, normalized: _)
        let step1 = handler.normalize(
            NormalizeInput { adapter: a.clone(), props: "{ "type": "navigation", "destination": "settings", "windowConfig": { "reuse": true } }".to_string() },
            &storage,
        ).await.unwrap();
        match step1 {
