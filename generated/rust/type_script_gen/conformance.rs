// generated: type_script_gen/conformance.rs

#[cfg(test)]
mod tests {
    use super::super::handler::TypeScriptGenHandler;
    use super::super::types::*;
    use crate::storage::create_in_memory_storage;

    #[tokio::test]
    async fn type_script_gen_invariant_1() {
