...
mod tests {
    ...
    async fn sync_compiler_invariant_1() {
        ...
        let step1 = handler.compile(
            CompileInput { sync: "s1".to_string(), ast: todo!(/* record: { "name": "TestSync".to_string(), "annotations": todo!(/* list: [] */), "when": todo!(/* list: [todo!(/* record: { "concept": "urn:clef/A".to_string(), "action": "act".to_string(), "inputFields": todo!(/* list: [] */), "outputFields": todo!(/* list: [] */) } */)] */), "where": todo!(/* list: [] */), "then": todo!(/* list: [todo!(/* record: { "concept": "urn:clef/B".to_string(), "action": "do".to_string(), "fields": todo!(/* list: [] */) } */)] */) } */) },
            &storage,
        ).await.unwrap();
        match step1 {
        ...
        let step2 = handler.compile(
            CompileInput { sync: "s2".to_string(), ast: todo!(/* record: { "name": "Bad".to_string(), "annotations": todo!(/* list: [] */), "when": todo!(/* list: [todo!(/* record: { "concept": "urn:clef/A".to_string(), "action": "act".to_string(), "inputFields": todo!(/* list: [] */), "outputFields": todo!(/* list: [] */) } */)] */), "where": todo!(/* list: [] */), "then": todo!(/* list: [] */) } */) },
            &storage,
        ).await.unwrap();
        match step2 {
