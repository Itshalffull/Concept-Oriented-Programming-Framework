// generated: terminal_adapter/conformance.rs

#[cfg(test)]
mod tests {
    use super::super::handler::TerminalAdapterHandler;
    use super::super::types::*;
    use crate::storage::create_in_memory_storage;

    #[tokio::test]
    async fn terminal_adapter_invariant_1() {
        ...
        // --- AFTER clause ---
        // normalize(adapter: a, props: "{ \"type\": \"navigation\", \"destination\": \"logs\" }") -> ok(adapter: a, normalized: _)
        let step1 = handler.normalize(
            NormalizeInput { adapter: a.clone(), props: "{ "type": "navigation", "destination": "logs" }".to_string() },
            &storage,
        ).await.unwrap();
        match step1 {
