...
/// @notice Generated from StorageAdapterScaffoldGen concept specification
...
contract StorageAdapterScaffoldGen {
    ...
    /// @notice generate
    function generate(string memory name, string memory backend) external returns (GenerateOkResult memory) {
        // TODO: Implement generate
        revert("Not implemented");
    }

    /// @notice preview
    function preview(string memory name, string memory backend) external returns (PreviewOkResult memory) {
