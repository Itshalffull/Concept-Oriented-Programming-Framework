...
/// @notice Generated from DeployScaffoldGen concept specification
...
contract DeployScaffoldGen {
    ...
    /// @notice generate
    function generate(string memory appName, bytes[] memory runtimes, bytes[] memory concepts) external returns (GenerateOkResult memory) {
        // TODO: Implement generate
        revert("Not implemented");
    }

    /// @notice preview
    function preview(string memory appName, bytes[] memory runtimes, bytes[] memory concepts) external returns (PreviewOkResult memory) {
