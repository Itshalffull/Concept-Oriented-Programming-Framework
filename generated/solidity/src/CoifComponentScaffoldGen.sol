...
/// @notice Generated from CoifComponentScaffoldGen concept specification
...
contract CoifComponentScaffoldGen {
    ...
    /// @notice generate
    function generate(string memory name, string[] memory parts, string[] memory states, string[] memory events) external returns (GenerateOkResult memory) {
        // TODO: Implement generate
        revert("Not implemented");
    }

    /// @notice preview
    function preview(string memory name, string[] memory parts, string[] memory states, string[] memory events) external returns (PreviewOkResult memory) {
