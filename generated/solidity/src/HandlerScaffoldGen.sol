...
/// @notice Generated from HandlerScaffoldGen concept specification
...
contract HandlerScaffoldGen {
    ...
    /// @notice generate
    function generate(string memory conceptName, bytes[] memory actions) external returns (GenerateOkResult memory) {
        // TODO: Implement generate
        revert("Not implemented");
    }

    /// @notice preview
    function preview(string memory conceptName, bytes[] memory actions) external returns (PreviewOkResult memory) {
