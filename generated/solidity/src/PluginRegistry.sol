...
contract PluginRegistry {
    ...
    event RegisterCompleted(string variant, bytes32 plugin);
    ...
    /// @notice register
    function register(string memory type, string memory name, string memory metadata) external returns (RegisterOkResult memory) {
