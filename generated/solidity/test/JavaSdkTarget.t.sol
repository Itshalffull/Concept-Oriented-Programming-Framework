...
import "../src/JavaSdkTarget.sol";

/// @title JavaSdkTarget Conformance Tests
/// @notice Generated from concept invariants
contract JavaSdkTargetTest is Test {
    JavaSdkTarget public target;

    function setUp() public {
        target = new JavaSdkTarget();
    }
