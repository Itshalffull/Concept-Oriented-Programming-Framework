...
import "../src/NextjsSdkTarget.sol";

/// @title NextjsSdkTarget Conformance Tests
/// @notice Generated from concept invariants
contract NextjsSdkTargetTest is Test {
    NextjsSdkTarget public target;

    function setUp() public {
        target = new NextjsSdkTarget();
    }
