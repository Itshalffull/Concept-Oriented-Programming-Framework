...
import "../src/NextjsAdapter.sol";

/// @title NextjsAdapter Conformance Tests
/// @notice Generated from concept invariants
contract NextjsAdapterTest is Test {
    NextjsAdapter public target;

    function setUp() public {
        target = new NextjsAdapter();
    }
