...
contract SolidityBuilderTest is Test {
    ...
    function test_invariant_1() public {
        ...
        // --- Assertions ---
        // test(build: l, toolchainPath: "/usr/local/bin/solc", invocation: { command: "forge test", args: ["--json", "--gas-report"], outputFormat: "forge-test-json", configFile: "foundry.toml", env: null }, testType: "unit") -> ok
        // target.test(l, "/usr/local/bin/solc", /* struct { command: "forge test", args: /* ["--json", "--gas-report"] */, outputFormat: "forge-test-json", configFile: "foundry.toml", env: null } */, "unit");
        // TODO: Assert ok variant
    }
