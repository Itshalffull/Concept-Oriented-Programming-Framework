...
import "../src/SwiftSdkTarget.sol";

/// @title SwiftSdkTarget Conformance Tests
/// @notice Generated from concept invariants
contract SwiftSdkTargetTest is Test {
    SwiftSdkTarget public target;

    function setUp() public {
        target = new SwiftSdkTarget();
    }
