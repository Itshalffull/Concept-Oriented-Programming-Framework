...
contract SwiftBuilderTest is Test {
    ...
    function test_invariant_1() public {
        ...
        // --- Assertions ---
        // test(build: s, toolchainPath: "/usr/bin/swiftc", invocation: { command: "swift test", args: ["--parallel"], outputFormat: "swift-test-json", configFile: "Package.swift", env: null }, testType: "unit") -> ok
        // target.test(s, "/usr/bin/swiftc", /* struct { command: "swift test", args: /* ["--parallel"] */, outputFormat: "swift-test-json", configFile: "Package.swift", env: null } */, "unit");
        // TODO: Assert ok variant
    }
