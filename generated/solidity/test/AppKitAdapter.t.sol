...
import "../src/AppKitAdapter.sol";

/// @title AppKitAdapter Conformance Tests
/// @notice Generated from concept invariants
contract AppKitAdapterTest is Test {
    AppKitAdapter public target;

    function setUp() public {
        target = new AppKitAdapter();
    }
