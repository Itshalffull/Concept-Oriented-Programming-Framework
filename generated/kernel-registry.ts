...
export const SYNC_FILES: string[] = [
  ...
  'suites/view-resolver/syncs/kernel-view-resolver-registration.sync',
  'suites/view-resolver/syncs/react-view-resolver-registration.sync',
  'suites/view-resolver/syncs/view-resolver-dispatches-to-provider.sync',
  'suites/view-resolver/syncs/kernel-resolver-fetches-data.sync',
  'suites/view-resolver/syncs/view-resolve-tracks-items.sync',
