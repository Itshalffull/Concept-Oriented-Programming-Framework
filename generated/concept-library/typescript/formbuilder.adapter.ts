// generated: formbuilder.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@copf/runtime";
import type { FormBuilderHandler } from "./formbuilder.handler";
import type { ConceptStorage } from "@copf/runtime";

export function createFormBuilderLiteAdapter(
  handler: FormBuilderHandler,
