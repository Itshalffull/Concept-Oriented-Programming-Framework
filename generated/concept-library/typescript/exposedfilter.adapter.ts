// generated: exposedfilter.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@copf/runtime";
import type { ExposedFilterHandler } from "./exposedfilter.handler";
import type { ConceptStorage } from "@copf/runtime";

export function createExposedFilterLiteAdapter(
  handler: ExposedFilterHandler,
