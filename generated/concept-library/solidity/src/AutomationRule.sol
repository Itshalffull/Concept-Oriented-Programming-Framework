...
contract AutomationRule {
    ...
    event EvaluateCompleted(string variant, bool matched);
    ...
    function enable(bytes32 rule) external returns (bool) {
        // Invariant checks
        // invariant 1: after define, enable, evaluate behaves correctly
        // require(..., "invariant 1: after define, enable, evaluate behaves correctly");
    ...
    /// @notice evaluate
    function evaluate(bytes32 rule, string memory event) external returns (EvaluateOkResult memory) {
        // Invariant checks
        // invariant 1: after define, enable, evaluate behaves correctly
        // require(..., "invariant 1: after define, enable, evaluate behaves correctly");
