// generated: User/Adapter.swift

import Foundation

class UserAdapter: ConceptTransport {
    private let handler: any UserHandler
    private let storage: ConceptStorage

    init(handler: any UserHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "register":
            let input = try decoder.decode(UserRegisterInput.self, from: invocation.inputData)
