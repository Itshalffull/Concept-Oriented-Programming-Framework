// generated: SchemaGen/Adapter.swift

import Foundation

class SchemaGenAdapter: ConceptTransport {
    private let handler: any SchemaGenHandler
    private let storage: ConceptStorage

    init(handler: any SchemaGenHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "generate":
            let input = try decoder.decode(SchemaGenGenerateInput.self, from: invocation.inputData)
