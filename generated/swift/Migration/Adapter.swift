// generated: Migration/Adapter.swift

import Foundation

class MigrationAdapter: ConceptTransport {
    private let handler: any MigrationHandler
    private let storage: ConceptStorage

    init(handler: any MigrationHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "check":
            let input = try decoder.decode(MigrationCheckInput.self, from: invocation.inputData)
        ...
        case "complete":
            let input = try decoder.decode(MigrationCompleteInput.self, from: invocation.inputData)
