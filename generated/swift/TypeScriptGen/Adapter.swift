// generated: TypeScriptGen/Adapter.swift

import Foundation

class TypeScriptGenAdapter: ConceptTransport {
    private let handler: any TypeScriptGenHandler
    private let storage: ConceptStorage

    init(handler: any TypeScriptGenHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "generate":
            let input = try decoder.decode(TypeScriptGenGenerateInput.self, from: invocation.inputData)
