...
final class TypeScriptGenConformanceTests: XCTestCase {
    ...
    func testTypeScriptGenInvariant1() async throws {
        ...
        let step1 = try await handler.generate(
            input: TypeScriptGenGenerateInput(spec: "s1", manifest: ["name": "Ping", "uri": "urn:copf/Ping", "typeParams": [], "relations": [], "actions": [["name": "ping", "params": [], "variants": [["tag": "ok", "fields": [], "prose": "Pong."]]]], "invariants": [], "graphqlSchema": "", "jsonSchemas": ["invocations": [], "completions": []], "capabilities": [], "purpose": "A test."]),
            storage: storage
        )
