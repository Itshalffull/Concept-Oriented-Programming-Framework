// generated: SpecParser/Adapter.swift

import Foundation

class SpecParserAdapter: ConceptTransport {
    private let handler: any SpecParserHandler
    private let storage: ConceptStorage

    init(handler: any SpecParserHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "parse":
            let input = try decoder.decode(SpecParserParseInput.self, from: invocation.inputData)
