// generated: SwiftGen/Adapter.swift

import Foundation

class SwiftGenAdapter: ConceptTransport {
    private let handler: any SwiftGenHandler
    private let storage: ConceptStorage

    init(handler: any SwiftGenHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "generate":
            let input = try decoder.decode(SwiftGenGenerateInput.self, from: invocation.inputData)
