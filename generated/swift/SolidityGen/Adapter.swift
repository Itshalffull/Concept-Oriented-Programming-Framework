// generated: SolidityGen/Adapter.swift

import Foundation

class SolidityGenAdapter: ConceptTransport {
    private let handler: any SolidityGenHandler
    private let storage: ConceptStorage

    init(handler: any SolidityGenHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "generate":
            let input = try decoder.decode(SolidityGenGenerateInput.self, from: invocation.inputData)
