// generated: Echo/Adapter.swift

import Foundation

class EchoAdapter: ConceptTransport {
    private let handler: any EchoHandler
    private let storage: ConceptStorage

    init(handler: any EchoHandler, storage: ConceptStorage) {
    ...
    func invoke(invocation: ActionInvocation) async throws -> ActionCompletion {
        ...
        case "send":
            let input = try decoder.decode(EchoSendInput.self, from: invocation.inputData)
