...
contract Relation {
    ...
    struct DefineRollupInput {
        bytes32 relation;
        string formula;
    }

    struct DefineRollupOkResult {
        bool success;
        bytes32 relation;
        string formula;
    }

    struct DefineRollupNotfoundResult {
        bool success;
        bytes32 relation;
    }

    struct ComputeRollupInput {
        bytes32 relation;
        string entity;
    }

    struct ComputeRollupOkResult {
        bool success;
        string value;
    }

    struct ComputeRollupNotfoundResult {
        bool success;
        bytes32 relation;
        string entity;
    }
    ...
    event DefineRollupCompleted(string variant, bytes32 relation);
    event ComputeRollupCompleted(string variant, bytes32 relation);
    ...
    /// @notice defineRollup
    function defineRollup(bytes32 relation, string memory formula) external returns (DefineRollupOkResult memory) {
        // TODO: Implement defineRollup
        revert("Not implemented");
    }

    /// @notice computeRollup
    function computeRollup(bytes32 relation, string memory entity) external returns (ComputeRollupOkResult memory) {
        // TODO: Implement computeRollup
        revert("Not implemented");
    }
