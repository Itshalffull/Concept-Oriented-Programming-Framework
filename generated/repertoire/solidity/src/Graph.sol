...
contract Graph {
    ...
    event ComputeLayoutCompleted(string variant);
    ...
    /// @notice computeLayout
    function computeLayout(bytes32 graph) external returns (ComputeLayoutOkResult memory) {
        // TODO: Implement computeLayout
        revert("Not implemented");
    }
