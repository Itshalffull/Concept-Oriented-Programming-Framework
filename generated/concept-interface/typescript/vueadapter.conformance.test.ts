// generated: vueadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@copf/runtime";
import { vueadapterHandler } from "./vueadapter.impl";

describe("VueAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await vueadapterHandler.normalize(
    ...
    const step2 = await vueadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
