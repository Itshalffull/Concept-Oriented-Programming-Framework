// generated: vanillaadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@copf/runtime";
import { vanillaadapterHandler } from "./vanillaadapter.impl";

describe("VanillaAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await vanillaadapterHandler.normalize(
    ...
    const step2 = await vanillaadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
