// generated: reactnativeadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@copf/runtime";
import { reactnativeadapterHandler } from "./reactnativeadapter.impl";

describe("ReactNativeAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await reactnativeadapterHandler.normalize(
    ...
    const step2 = await reactnativeadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
