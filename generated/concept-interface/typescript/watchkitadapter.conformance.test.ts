// generated: watchkitadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@copf/runtime";
import { watchkitadapterHandler } from "./watchkitadapter.impl";

describe("WatchKitAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await watchkitadapterHandler.normalize(
    ...
    const step2 = await watchkitadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
