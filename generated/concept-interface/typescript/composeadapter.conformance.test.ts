// generated: composeadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@copf/runtime";
import { composeadapterHandler } from "./composeadapter.impl";

describe("ComposeAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await composeadapterHandler.normalize(
    ...
    const step2 = await composeadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
