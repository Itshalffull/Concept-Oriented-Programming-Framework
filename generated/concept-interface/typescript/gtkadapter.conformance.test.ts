// generated: gtkadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@copf/runtime";
import { gtkadapterHandler } from "./gtkadapter.impl";

describe("GTKAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await gtkadapterHandler.normalize(
    ...
    const step2 = await gtkadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
