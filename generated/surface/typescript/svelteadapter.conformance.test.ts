// generated: svelteadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@clef/runtime";
import { svelteadapterHandler } from "./svelteadapter.impl";

describe("SvelteAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await svelteadapterHandler.normalize(
    ...
    const step2 = await svelteadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
