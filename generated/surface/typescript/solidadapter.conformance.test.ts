// generated: solidadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@clef/runtime";
import { solidadapterHandler } from "./solidadapter.impl";

describe("SolidAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await solidadapterHandler.normalize(
    ...
    const step2 = await solidadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
