// generated: solidadapter.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@clef/runtime";
import type { SolidAdapterHandler } from "./solidadapter.handler";
import type { ConceptStorage } from "@clef/runtime";

export function createSolidAdapterLiteAdapter(
  handler: SolidAdapterHandler,
