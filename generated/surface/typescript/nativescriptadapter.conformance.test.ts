// generated: nativescriptadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@clef/runtime";
import { nativescriptadapterHandler } from "./nativescriptadapter.impl";

describe("NativeScriptAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await nativescriptadapterHandler.normalize(
    ...
    const step2 = await nativescriptadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
