// generated: wearcomposeadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@clef/runtime";
import { wearcomposeadapterHandler } from "./wearcomposeadapter.impl";

describe("WearComposeAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await wearcomposeadapterHandler.normalize(
    ...
    const step2 = await wearcomposeadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
