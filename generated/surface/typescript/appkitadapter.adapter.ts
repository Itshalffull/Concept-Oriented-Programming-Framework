// generated: appkitadapter.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@clef/runtime";
import type { AppKitAdapterHandler } from "./appkitadapter.handler";
import type { ConceptStorage } from "@clef/runtime";

export function createAppKitAdapterLiteAdapter(
  handler: AppKitAdapterHandler,
