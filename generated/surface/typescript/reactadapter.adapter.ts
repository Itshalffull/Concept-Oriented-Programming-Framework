// generated: reactadapter.adapter.ts
import type {
  ActionInvocation, ActionCompletion,
  ConceptTransport, ConceptQuery
} from "@clef/runtime";
import type { ReactAdapterHandler } from "./reactadapter.handler";
import type { ConceptStorage } from "@clef/runtime";

export function createReactAdapterLiteAdapter(
  handler: ReactAdapterHandler,
