// generated: appkitadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@clef/runtime";
import { appkitadapterHandler } from "./appkitadapter.impl";

describe("AppKitAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await appkitadapterHandler.normalize(
    ...
    const step2 = await appkitadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
