// generated: swiftuiadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@clef/runtime";
import { swiftuiadapterHandler } from "./swiftuiadapter.impl";

describe("SwiftUIAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await swiftuiadapterHandler.normalize(
    ...
    const step2 = await swiftuiadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
