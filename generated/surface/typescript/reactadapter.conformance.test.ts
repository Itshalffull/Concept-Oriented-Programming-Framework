// generated: reactadapter.conformance.test.ts
import { describe, it, expect } from "vitest";
import { createInMemoryStorage } from "@clef/runtime";
import { reactadapterHandler } from "./reactadapter.impl";

describe("ReactAdapter conformance", () => {
  ...
  it("invariant 1: after normalize, normalize behaves correctly", async () => {
    ...
    const step1 = await reactadapterHandler.normalize(
    ...
    const step2 = await reactadapterHandler.normalize(
      { adapter: a, props: "" },
      storage,
    );
