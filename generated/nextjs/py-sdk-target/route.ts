...
import type { PySdkTargetHandler, PySdkTargetError } from './handler.js';
import type { PySdkTargetStorage } from './types.js';

const errorResponse = (error: PySdkTargetError, status = 422): NextResponse =>
...
export const createPySdkTargetRoutes = (
  handler: PySdkTargetHandler,
