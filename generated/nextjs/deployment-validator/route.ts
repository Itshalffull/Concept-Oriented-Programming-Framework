...
import type { DeploymentValidatorHandler, DeploymentValidatorError } from './handler.js';
import type { DeploymentValidatorStorage } from './types.js';

const errorResponse = (error: DeploymentValidatorError, status = 422): NextResponse =>
...
export const createDeploymentValidatorRoutes = (
  handler: DeploymentValidatorHandler,
