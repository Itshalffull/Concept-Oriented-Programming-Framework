...
// Place at: app/api/config-sync/route.ts
...
import type { ConfigSyncHandler, ConfigSyncError } from './handler.js';
import type { ConfigSyncStorage } from './types.js';

const errorResponse = (error: ConfigSyncError, status = 422): NextResponse =>
...
export const createConfigSyncRoutes = (
