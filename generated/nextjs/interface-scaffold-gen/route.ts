...
import type { InterfaceScaffoldGenHandler, InterfaceScaffoldGenError } from './handler.js';
import type { InterfaceScaffoldGenStorage } from './types.js';

const errorResponse = (error: InterfaceScaffoldGenError, status = 422): NextResponse =>
...
export const createInterfaceScaffoldGenRoutes = (
  handler: InterfaceScaffoldGenHandler,
