// LLMAutomationProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/llm-automation-provider/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { LLMAutomationProviderHandler, LLMAutomationProviderError } from './handler.js';
import type { LLMAutomationProviderStorage } from './types.js';

const errorResponse = (error: LLMAutomationProviderError, status = 422): NextResponse =>
...
export const createLLMAutomationProviderRoutes = (
  handler: LLMAutomationProviderHandler,
