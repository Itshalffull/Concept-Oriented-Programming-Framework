...
// Place at: app/api/assertion/route.ts
...
import type { AssertionHandler, AssertionError } from './handler.js';
import type { AssertionStorage } from './types.js';

const errorResponse = (error: AssertionError, status = 422): NextResponse =>
...
export const createAssertionRoutes = (
