// DatalogDependenceProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/datalog-dependence-provider/route.ts
...
import type { DatalogDependenceProviderHandler, DatalogDependenceProviderError } from './handler.js';
import type { DatalogDependenceProviderStorage } from './types.js';

const errorResponse = (error: DatalogDependenceProviderError, status = 422): NextResponse =>
...
export const createDatalogDependenceProviderRoutes = (
  handler: DatalogDependenceProviderHandler,
