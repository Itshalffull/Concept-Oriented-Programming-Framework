...
import type { CoifThemeScaffoldGenHandler, CoifThemeScaffoldGenError } from './handler.js';
import type { CoifThemeScaffoldGenStorage } from './types.js';

const errorResponse = (error: CoifThemeScaffoldGenError, status = 422): NextResponse =>
...
export const createCoifThemeScaffoldGenRoutes = (
  handler: CoifThemeScaffoldGenHandler,
