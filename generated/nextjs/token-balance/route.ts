...
import type { TokenBalanceHandler, TokenBalanceError } from './handler.js';
import type { TokenBalanceStorage } from './types.js';

const errorResponse = (error: TokenBalanceError, status = 422): NextResponse =>
...
export const createTokenBalanceRoutes = (
