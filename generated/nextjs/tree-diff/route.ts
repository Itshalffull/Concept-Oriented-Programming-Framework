...
// Place at: app/api/tree-diff/route.ts
...
import type { TreeDiffHandler, TreeDiffError } from './handler.js';
import type { TreeDiffStorage } from './types.js';

const errorResponse = (error: TreeDiffError, status = 422): NextResponse =>
...
export const createTreeDiffRoutes = (
  handler: TreeDiffHandler,
