// ReactComponentSymbolExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/react-component-symbol-extractor/route.ts
...
import type { ReactComponentSymbolExtractorHandler, ReactComponentSymbolExtractorError } from './handler.js';
import type { ReactComponentSymbolExtractorStorage } from './types.js';

const errorResponse = (error: ReactComponentSymbolExtractorError, status = 422): NextResponse =>
...
export const createReactComponentSymbolExtractorRoutes = (
  handler: ReactComponentSymbolExtractorHandler,
