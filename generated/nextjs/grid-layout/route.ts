...
// Place at: app/api/grid-layout/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { GridLayoutHandler, GridLayoutError } from './handler.js';
import type { GridLayoutStorage } from './types.js';

const errorResponse = (error: GridLayoutError, status = 422): NextResponse =>
...
export const createGridLayoutRoutes = (
  handler: GridLayoutHandler,
