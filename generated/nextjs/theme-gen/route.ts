...
// Place at: app/api/theme-gen/route.ts
...
import type { ThemeGenHandler, ThemeGenError } from './handler.js';
import type { ThemeGenStorage } from './types.js';

const errorResponse = (error: ThemeGenError, status = 422): NextResponse =>
...
export const createThemeGenRoutes = (
  handler: ThemeGenHandler,
