...
// Place at: app/api/annotation/route.ts
...
import type { AnnotationHandler, AnnotationError } from './handler.js';
import type { AnnotationStorage } from './types.js';

const errorResponse = (error: AnnotationError, status = 422): NextResponse =>
