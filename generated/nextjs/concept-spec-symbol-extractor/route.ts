// ConceptSpecSymbolExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/concept-spec-symbol-extractor/route.ts
...
import type { ConceptSpecSymbolExtractorHandler, ConceptSpecSymbolExtractorError } from './handler.js';
import type { ConceptSpecSymbolExtractorStorage } from './types.js';

const errorResponse = (error: ConceptSpecSymbolExtractorError, status = 422): NextResponse =>
...
export const createConceptSpecSymbolExtractorRoutes = (
  handler: ConceptSpecSymbolExtractorHandler,
