...
// Place at: app/api/deploy-plan/route.ts
...
import type { DeployPlanHandler, DeployPlanError } from './handler.js';
import type { DeployPlanStorage } from './types.js';

const errorResponse = (error: DeployPlanError, status = 422): NextResponse =>
...
export const createDeployPlanRoutes = (
