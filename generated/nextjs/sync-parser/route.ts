...
// Place at: app/api/sync-parser/route.ts
...
import type { SyncParserHandler, SyncParserError } from './handler.js';
import type { SyncParserStorage } from './types.js';

const errorResponse = (error: SyncParserError, status = 422): NextResponse =>
...
export const createSyncParserRoutes = (
  handler: SyncParserHandler,
