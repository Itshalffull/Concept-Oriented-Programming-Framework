// HierarchicalLayout — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/hierarchical-layout/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { HierarchicalLayoutHandler, HierarchicalLayoutError } from './handler.js';
import type { HierarchicalLayoutStorage } from './types.js';

const errorResponse = (error: HierarchicalLayoutError, status = 422): NextResponse =>
...
export const createHierarchicalLayoutRoutes = (
  handler: HierarchicalLayoutHandler,
