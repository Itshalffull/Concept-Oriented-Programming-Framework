...
import type { TrigramIndexProviderHandler, TrigramIndexProviderError } from './handler.js';
import type { TrigramIndexProviderStorage } from './types.js';

const errorResponse = (error: TrigramIndexProviderError, status = 422): NextResponse =>
...
export const createTrigramIndexProviderRoutes = (
  handler: TrigramIndexProviderHandler,
