...
// Place at: app/api/milestone/route.ts
...
import type { MilestoneHandler, MilestoneError } from './handler.js';
import type { MilestoneStorage } from './types.js';

const errorResponse = (error: MilestoneError, status = 422): NextResponse =>
...
export const createMilestoneRoutes = (
