...
import type { LatticeMergeHandler, LatticeMergeError } from './handler.js';
import type { LatticeMergeStorage } from './types.js';

const errorResponse = (error: LatticeMergeError, status = 422): NextResponse =>
...
export const createLatticeMergeRoutes = (
  handler: LatticeMergeHandler,
