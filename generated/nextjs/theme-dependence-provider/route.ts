// ThemeDependenceProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/theme-dependence-provider/route.ts
...
import type { ThemeDependenceProviderHandler, ThemeDependenceProviderError } from './handler.js';
import type { ThemeDependenceProviderStorage } from './types.js';

const errorResponse = (error: ThemeDependenceProviderError, status = 422): NextResponse =>
...
export const createThemeDependenceProviderRoutes = (
  handler: ThemeDependenceProviderHandler,
