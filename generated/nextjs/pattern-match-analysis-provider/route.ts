// PatternMatchAnalysisProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/pattern-match-analysis-provider/route.ts
...
import type { PatternMatchAnalysisProviderHandler, PatternMatchAnalysisProviderError } from './handler.js';
import type { PatternMatchAnalysisProviderStorage } from './types.js';

const errorResponse = (error: PatternMatchAnalysisProviderError, status = 422): NextResponse =>
...
export const createPatternMatchAnalysisProviderRoutes = (
  handler: PatternMatchAnalysisProviderHandler,
