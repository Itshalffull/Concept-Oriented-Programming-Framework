...
import type { ThemeParserHandler, ThemeParserError } from './handler.js';
import type { ThemeParserStorage } from './types.js';

const errorResponse = (error: ThemeParserError, status = 422): NextResponse =>
...
export const createThemeParserRoutes = (
  handler: ThemeParserHandler,
