...
import type { HandlerScaffoldGenHandler, HandlerScaffoldGenError } from './handler.js';
import type { HandlerScaffoldGenStorage } from './types.js';

const errorResponse = (error: HandlerScaffoldGenError, status = 422): NextResponse =>
...
export const createHandlerScaffoldGenRoutes = (
  handler: HandlerScaffoldGenHandler,
