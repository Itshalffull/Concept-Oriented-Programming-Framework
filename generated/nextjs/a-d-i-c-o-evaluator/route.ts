...
import type { ADICOEvaluatorHandler, ADICOEvaluatorError } from './handler.js';
import type { ADICOEvaluatorStorage } from './types.js';

const errorResponse = (error: ADICOEvaluatorError, status = 422): NextResponse =>
...
export const createADICOEvaluatorRoutes = (
  handler: ADICOEvaluatorHandler,
