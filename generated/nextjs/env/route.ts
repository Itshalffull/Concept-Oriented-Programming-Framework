...
import type { EnvHandler, EnvError } from './handler.js';
import type { EnvStorage } from './types.js';

const errorResponse = (error: EnvError, status = 422): NextResponse =>
