...
import type { SolidityToolchainHandler, SolidityToolchainError } from './handler.js';
import type { SolidityToolchainStorage } from './types.js';

const errorResponse = (error: SolidityToolchainError, status = 422): NextResponse =>
...
export const createSolidityToolchainRoutes = (
  handler: SolidityToolchainHandler,
