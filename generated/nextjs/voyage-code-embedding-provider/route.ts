// VoyageCodeEmbeddingProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/voyage-code-embedding-provider/route.ts
...
import type { VoyageCodeEmbeddingProviderHandler, VoyageCodeEmbeddingProviderError } from './handler.js';
import type { VoyageCodeEmbeddingProviderStorage } from './types.js';

const errorResponse = (error: VoyageCodeEmbeddingProviderError, status = 422): NextResponse =>
...
export const createVoyageCodeEmbeddingProviderRoutes = (
  handler: VoyageCodeEmbeddingProviderHandler,
