...
import type { WearComposeAdapterHandler, WearComposeAdapterError } from './handler.js';
import type { WearComposeAdapterStorage } from './types.js';

const errorResponse = (error: WearComposeAdapterError, status = 422): NextResponse =>
...
export const createWearComposeAdapterRoutes = (
