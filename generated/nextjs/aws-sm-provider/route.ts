...
import type { AwsSmProviderHandler, AwsSmProviderError } from './handler.js';
import type { AwsSmProviderStorage } from './types.js';

const errorResponse = (error: AwsSmProviderError, status = 422): NextResponse =>
...
export const createAwsSmProviderRoutes = (
