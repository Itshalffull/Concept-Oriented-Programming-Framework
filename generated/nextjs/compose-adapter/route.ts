...
import type { ComposeAdapterHandler, ComposeAdapterError } from './handler.js';
import type { ComposeAdapterStorage } from './types.js';

const errorResponse = (error: ComposeAdapterError, status = 422): NextResponse =>
...
export const createComposeAdapterRoutes = (
