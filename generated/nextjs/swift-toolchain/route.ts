...
import type { SwiftToolchainHandler, SwiftToolchainError } from './handler.js';
import type { SwiftToolchainStorage } from './types.js';

const errorResponse = (error: SwiftToolchainError, status = 422): NextResponse =>
...
export const createSwiftToolchainRoutes = (
  handler: SwiftToolchainHandler,
