...
import type { SvelteAdapterHandler, SvelteAdapterError } from './handler.js';
import type { SvelteAdapterStorage } from './types.js';

const errorResponse = (error: SvelteAdapterError, status = 422): NextResponse =>
...
export const createSvelteAdapterRoutes = (
