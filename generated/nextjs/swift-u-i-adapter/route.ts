...
import type { SwiftUIAdapterHandler, SwiftUIAdapterError } from './handler.js';
import type { SwiftUIAdapterStorage } from './types.js';

const errorResponse = (error: SwiftUIAdapterError, status = 422): NextResponse =>
...
export const createSwiftUIAdapterRoutes = (
