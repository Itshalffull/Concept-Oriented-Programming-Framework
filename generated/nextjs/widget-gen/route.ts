...
// Place at: app/api/widget-gen/route.ts
...
import type { WidgetGenHandler, WidgetGenError } from './handler.js';
import type { WidgetGenStorage } from './types.js';

const errorResponse = (error: WidgetGenError, status = 422): NextResponse =>
...
export const createWidgetGenRoutes = (
  handler: WidgetGenHandler,
