// TypeScriptSymbolExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/type-script-symbol-extractor/route.ts
...
import type { TypeScriptSymbolExtractorHandler, TypeScriptSymbolExtractorError } from './handler.js';
import type { TypeScriptSymbolExtractorStorage } from './types.js';

const errorResponse = (error: TypeScriptSymbolExtractorError, status = 422): NextResponse =>
...
export const createTypeScriptSymbolExtractorRoutes = (
  handler: TypeScriptSymbolExtractorHandler,
