...
// Place at: app/api/ia-c/route.ts
...
import type { IaCHandler, IaCError } from './handler.js';
import type { IaCStorage } from './types.js';

const errorResponse = (error: IaCError, status = 422): NextResponse =>
