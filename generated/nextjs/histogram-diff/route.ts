...
import type { HistogramDiffHandler, HistogramDiffError } from './handler.js';
import type { HistogramDiffStorage } from './types.js';

const errorResponse = (error: HistogramDiffError, status = 422): NextResponse =>
...
export const createHistogramDiffRoutes = (
  handler: HistogramDiffHandler,
