...
import type { GoSdkTargetHandler, GoSdkTargetError } from './handler.js';
import type { GoSdkTargetStorage } from './types.js';

const errorResponse = (error: GoSdkTargetError, status = 422): NextResponse =>
...
export const createGoSdkTargetRoutes = (
  handler: GoSdkTargetHandler,
