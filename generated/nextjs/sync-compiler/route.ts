...
import type { SyncCompilerHandler, SyncCompilerError } from './handler.js';
import type { SyncCompilerStorage } from './types.js';

const errorResponse = (error: SyncCompilerError, status = 422): NextResponse =>
...
export const createSyncCompilerRoutes = (
  handler: SyncCompilerHandler,
