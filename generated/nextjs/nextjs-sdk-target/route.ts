...
import type { NextjsSdkTargetHandler, NextjsSdkTargetError } from './handler.js';
import type { NextjsSdkTargetStorage } from './types.js';

const errorResponse = (error: NextjsSdkTargetError, status = 422): NextResponse =>
...
export const createNextjsSdkTargetRoutes = (
  handler: NextjsSdkTargetHandler,
