...
import type { WidgetGenInkHandler, WidgetGenInkError } from './handler.js';
import type { WidgetGenInkStorage } from './types.js';

const errorResponse = (error: WidgetGenInkError, status = 422): NextResponse =>
...
export const createWidgetGenInkRoutes = (
  handler: WidgetGenInkHandler,
