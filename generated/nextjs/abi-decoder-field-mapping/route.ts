// AbiDecoderFieldMapping — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/abi-decoder-field-mapping/route.ts
...
import type { AbiDecoderFieldMappingHandler, AbiDecoderFieldMappingError } from './handler.js';
import type { AbiDecoderFieldMappingStorage } from './types.js';

const errorResponse = (error: AbiDecoderFieldMappingError, status = 422): NextResponse =>
...
export const createAbiDecoderFieldMappingRoutes = (
  handler: AbiDecoderFieldMappingHandler,
