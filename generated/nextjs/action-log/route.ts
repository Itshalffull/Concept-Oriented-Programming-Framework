...
// Place at: app/api/action-log/route.ts
...
import type { ActionLogHandler, ActionLogError } from './handler.js';
import type { ActionLogStorage } from './types.js';

const errorResponse = (error: ActionLogError, status = 422): NextResponse =>
