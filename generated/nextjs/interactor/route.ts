...
// Place at: app/api/interactor/route.ts
...
import type { InteractorHandler, InteractorError } from './handler.js';
import type { InteractorStorage } from './types.js';

const errorResponse = (error: InteractorError, status = 422): NextResponse =>
...
export const createInteractorRoutes = (
