...
import type { WatchKitAdapterHandler, WatchKitAdapterError } from './handler.js';
import type { WatchKitAdapterStorage } from './types.js';

const errorResponse = (error: WatchKitAdapterError, status = 422): NextResponse =>
...
export const createWatchKitAdapterRoutes = (
