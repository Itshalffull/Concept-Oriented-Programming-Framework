...
// Place at: app/api/g-t-k-adapter/route.ts
...
import type { GTKAdapterHandler, GTKAdapterError } from './handler.js';
import type { GTKAdapterStorage } from './types.js';

const errorResponse = (error: GTKAdapterError, status = 422): NextResponse =>
...
export const createGTKAdapterRoutes = (
