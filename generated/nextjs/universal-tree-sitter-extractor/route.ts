// UniversalTreeSitterExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/universal-tree-sitter-extractor/route.ts
...
import type { UniversalTreeSitterExtractorHandler, UniversalTreeSitterExtractorError } from './handler.js';
import type { UniversalTreeSitterExtractorStorage } from './types.js';

const errorResponse = (error: UniversalTreeSitterExtractorError, status = 422): NextResponse =>
...
export const createUniversalTreeSitterExtractorRoutes = (
  handler: UniversalTreeSitterExtractorHandler,
