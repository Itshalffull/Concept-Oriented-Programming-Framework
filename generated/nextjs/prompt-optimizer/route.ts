...
import type { PromptOptimizerHandler, PromptOptimizerError } from './handler.js';
import type { PromptOptimizerStorage } from './types.js';

const errorResponse = (error: PromptOptimizerError, status = 422): NextResponse =>
...
export const createPromptOptimizerRoutes = (
  handler: PromptOptimizerHandler,
