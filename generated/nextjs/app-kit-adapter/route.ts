...
import type { AppKitAdapterHandler, AppKitAdapterError } from './handler.js';
import type { AppKitAdapterStorage } from './types.js';

const errorResponse = (error: AppKitAdapterError, status = 422): NextResponse =>
...
export const createAppKitAdapterRoutes = (
