...
import type { MultiValueResolutionHandler, MultiValueResolutionError } from './handler.js';
import type { MultiValueResolutionStorage } from './types.js';

const errorResponse = (error: MultiValueResolutionError, status = 422): NextResponse =>
...
export const createMultiValueResolutionRoutes = (
  handler: MultiValueResolutionHandler,
