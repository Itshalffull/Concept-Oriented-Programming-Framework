...
// Place at: app/api/connector/route.ts
...
import type { ConnectorHandler, ConnectorError } from './handler.js';
import type { ConnectorStorage } from './types.js';

const errorResponse = (error: ConnectorError, status = 422): NextResponse =>
...
export const createConnectorRoutes = (
