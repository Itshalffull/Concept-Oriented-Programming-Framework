...
// Place at: app/api/edge-target/route.ts
...
import type { EdgeTargetHandler, EdgeTargetError } from './handler.js';
import type { EdgeTargetStorage } from './types.js';

const errorResponse = (error: EdgeTargetError, status = 422): NextResponse =>
...
export const createEdgeTargetRoutes = (
  handler: EdgeTargetHandler,
