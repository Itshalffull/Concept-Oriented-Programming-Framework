// CssTokenSymbolExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/css-token-symbol-extractor/route.ts
...
import type { CssTokenSymbolExtractorHandler, CssTokenSymbolExtractorError } from './handler.js';
import type { CssTokenSymbolExtractorStorage } from './types.js';

const errorResponse = (error: CssTokenSymbolExtractorError, status = 422): NextResponse =>
...
export const createCssTokenSymbolExtractorRoutes = (
  handler: CssTokenSymbolExtractorHandler,
