// TypeScriptDependenceProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/type-script-dependence-provider/route.ts
...
import type { TypeScriptDependenceProviderHandler, TypeScriptDependenceProviderError } from './handler.js';
import type { TypeScriptDependenceProviderStorage } from './types.js';

const errorResponse = (error: TypeScriptDependenceProviderError, status = 422): NextResponse =>
...
export const createTypeScriptDependenceProviderRoutes = (
  handler: TypeScriptDependenceProviderHandler,
