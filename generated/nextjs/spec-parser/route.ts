...
// Place at: app/api/spec-parser/route.ts
...
import type { SpecParserHandler, SpecParserError } from './handler.js';
import type { SpecParserStorage } from './types.js';

const errorResponse = (error: SpecParserError, status = 422): NextResponse =>
...
export const createSpecParserRoutes = (
  handler: SpecParserHandler,
