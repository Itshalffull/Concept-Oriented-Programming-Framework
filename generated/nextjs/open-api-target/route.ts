...
import type { OpenApiTargetHandler, OpenApiTargetError } from './handler.js';
import type { OpenApiTargetStorage } from './types.js';

const errorResponse = (error: OpenApiTargetError, status = 422): NextResponse =>
...
export const createOpenApiTargetRoutes = (
  handler: OpenApiTargetHandler,
