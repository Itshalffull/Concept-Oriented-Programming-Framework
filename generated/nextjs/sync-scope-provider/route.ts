...
import type { SyncScopeProviderHandler, SyncScopeProviderError } from './handler.js';
import type { SyncScopeProviderStorage } from './types.js';

const errorResponse = (error: SyncScopeProviderError, status = 422): NextResponse =>
...
export const createSyncScopeProviderRoutes = (
  handler: SyncScopeProviderHandler,
