...
import type { TreeSitterSyncSpecHandler, TreeSitterSyncSpecError } from './handler.js';
import type { TreeSitterSyncSpecStorage } from './types.js';

const errorResponse = (error: TreeSitterSyncSpecError, status = 422): NextResponse =>
...
export const createTreeSitterSyncSpecRoutes = (
  handler: TreeSitterSyncSpecHandler,
