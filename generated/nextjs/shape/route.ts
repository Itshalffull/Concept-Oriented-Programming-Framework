...
// Place at: app/api/shape/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { ShapeHandler, ShapeError } from './handler.js';
import type { ShapeStorage } from './types.js';

const errorResponse = (error: ShapeError, status = 422): NextResponse =>
...
export const createShapeRoutes = (
