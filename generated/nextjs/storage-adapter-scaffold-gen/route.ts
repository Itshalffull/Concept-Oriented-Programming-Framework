// StorageAdapterScaffoldGen — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/storage-adapter-scaffold-gen/route.ts
...
import type { StorageAdapterScaffoldGenHandler, StorageAdapterScaffoldGenError } from './handler.js';
import type { StorageAdapterScaffoldGenStorage } from './types.js';

const errorResponse = (error: StorageAdapterScaffoldGenError, status = 422): NextResponse =>
...
export const createStorageAdapterScaffoldGenRoutes = (
  handler: StorageAdapterScaffoldGenHandler,
