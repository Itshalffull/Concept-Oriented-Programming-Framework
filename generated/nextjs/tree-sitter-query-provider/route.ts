// TreeSitterQueryProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/tree-sitter-query-provider/route.ts
...
import type { TreeSitterQueryProviderHandler, TreeSitterQueryProviderError } from './handler.js';
import type { TreeSitterQueryProviderStorage } from './types.js';

const errorResponse = (error: TreeSitterQueryProviderError, status = 422): NextResponse =>
...
export const createTreeSitterQueryProviderRoutes = (
  handler: TreeSitterQueryProviderHandler,
