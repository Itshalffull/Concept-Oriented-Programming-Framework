...
// Place at: app/api/myers-diff/route.ts
...
import type { MyersDiffHandler, MyersDiffError } from './handler.js';
import type { MyersDiffStorage } from './types.js';

const errorResponse = (error: MyersDiffError, status = 422): NextResponse =>
...
export const createMyersDiffRoutes = (
  handler: MyersDiffHandler,
