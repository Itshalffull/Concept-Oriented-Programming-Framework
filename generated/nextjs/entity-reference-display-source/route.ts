// EntityReferenceDisplaySource — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/entity-reference-display-source/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { EntityReferenceDisplaySourceHandler, EntityReferenceDisplaySourceError } from './handler.js';
import type { EntityReferenceDisplaySourceStorage } from './types.js';

const errorResponse = (error: EntityReferenceDisplaySourceError, status = 422): NextResponse =>
...
export const createEntityReferenceDisplaySourceRoutes = (
  handler: EntityReferenceDisplaySourceHandler,
