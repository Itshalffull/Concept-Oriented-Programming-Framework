...
// Place at: app/api/nextjs-gen/route.ts
...
import type { NextjsGenHandler, NextjsGenError } from './handler.js';
import type { NextjsGenStorage } from './types.js';

const errorResponse = (error: NextjsGenError, status = 422): NextResponse =>
...
export const createNextjsGenRoutes = (
