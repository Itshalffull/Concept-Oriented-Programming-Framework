...
import type { AsyncApiTargetHandler, AsyncApiTargetError } from './handler.js';
import type { AsyncApiTargetStorage } from './types.js';

const errorResponse = (error: AsyncApiTargetError, status = 422): NextResponse =>
...
export const createAsyncApiTargetRoutes = (
  handler: AsyncApiTargetHandler,
