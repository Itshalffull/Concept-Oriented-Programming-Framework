// ThemeSpecSymbolExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/theme-spec-symbol-extractor/route.ts
...
import type { ThemeSpecSymbolExtractorHandler, ThemeSpecSymbolExtractorError } from './handler.js';
import type { ThemeSpecSymbolExtractorStorage } from './types.js';

const errorResponse = (error: ThemeSpecSymbolExtractorError, status = 422): NextResponse =>
...
export const createThemeSpecSymbolExtractorRoutes = (
  handler: ThemeSpecSymbolExtractorHandler,
