...
import type { NextjsAdapterHandler, NextjsAdapterError } from './handler.js';
import type { NextjsAdapterStorage } from './types.js';

const errorResponse = (error: NextjsAdapterError, status = 422): NextResponse =>
...
export const createNextjsAdapterRoutes = (
  handler: NextjsAdapterHandler,
