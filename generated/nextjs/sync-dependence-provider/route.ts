...
import type { SyncDependenceProviderHandler, SyncDependenceProviderError } from './handler.js';
import type { SyncDependenceProviderStorage } from './types.js';

const errorResponse = (error: SyncDependenceProviderError, status = 422): NextResponse =>
...
export const createSyncDependenceProviderRoutes = (
  handler: SyncDependenceProviderHandler,
