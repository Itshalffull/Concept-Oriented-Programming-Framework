...
import type { TreeSitterYamlHandler, TreeSitterYamlError } from './handler.js';
import type { TreeSitterYamlStorage } from './types.js';

const errorResponse = (error: TreeSitterYamlError, status = 422): NextResponse =>
...
export const createTreeSitterYamlRoutes = (
  handler: TreeSitterYamlHandler,
