...
import type { VanillaAdapterHandler, VanillaAdapterError } from './handler.js';
import type { VanillaAdapterStorage } from './types.js';

const errorResponse = (error: VanillaAdapterError, status = 422): NextResponse =>
...
export const createVanillaAdapterRoutes = (
