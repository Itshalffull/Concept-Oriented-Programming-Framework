...
import type { DotenvProviderHandler, DotenvProviderError } from './handler.js';
import type { DotenvProviderStorage } from './types.js';

const errorResponse = (error: DotenvProviderError, status = 422): NextResponse =>
...
export const createDotenvProviderRoutes = (
