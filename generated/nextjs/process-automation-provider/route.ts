// ProcessAutomationProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/process-automation-provider/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { ProcessAutomationProviderHandler, ProcessAutomationProviderError } from './handler.js';
import type { ProcessAutomationProviderStorage } from './types.js';

const errorResponse = (error: ProcessAutomationProviderError, status = 422): NextResponse =>
...
export const createProcessAutomationProviderRoutes = (
  handler: ProcessAutomationProviderHandler,
