...
import type { NativeScriptAdapterHandler, NativeScriptAdapterError } from './handler.js';
import type { NativeScriptAdapterStorage } from './types.js';

const errorResponse = (error: NativeScriptAdapterError, status = 422): NextResponse =>
...
export const createNativeScriptAdapterRoutes = (
