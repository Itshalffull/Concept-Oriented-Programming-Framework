...
import type { WidgetGenWinUIHandler, WidgetGenWinUIError } from './handler.js';
import type { WidgetGenWinUIStorage } from './types.js';

const errorResponse = (error: WidgetGenWinUIError, status = 422): NextResponse =>
...
export const createWidgetGenWinUIRoutes = (
  handler: WidgetGenWinUIHandler,
