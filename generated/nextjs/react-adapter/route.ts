...
import type { ReactAdapterHandler, ReactAdapterError } from './handler.js';
import type { ReactAdapterStorage } from './types.js';

const errorResponse = (error: ReactAdapterError, status = 422): NextResponse =>
...
export const createReactAdapterRoutes = (
