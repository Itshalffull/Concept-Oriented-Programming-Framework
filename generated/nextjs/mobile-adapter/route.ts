...
import type { MobileAdapterHandler, MobileAdapterError } from './handler.js';
import type { MobileAdapterStorage } from './types.js';

const errorResponse = (error: MobileAdapterError, status = 422): NextResponse =>
...
export const createMobileAdapterRoutes = (
  handler: MobileAdapterHandler,
