...
import type { ConceptScopeProviderHandler, ConceptScopeProviderError } from './handler.js';
import type { ConceptScopeProviderStorage } from './types.js';

const errorResponse = (error: ConceptScopeProviderError, status = 422): NextResponse =>
...
export const createConceptScopeProviderRoutes = (
  handler: ConceptScopeProviderHandler,
