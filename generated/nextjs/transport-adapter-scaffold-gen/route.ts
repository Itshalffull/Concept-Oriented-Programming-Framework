// TransportAdapterScaffoldGen — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/transport-adapter-scaffold-gen/route.ts
...
import type { TransportAdapterScaffoldGenHandler, TransportAdapterScaffoldGenError } from './handler.js';
import type { TransportAdapterScaffoldGenStorage } from './types.js';

const errorResponse = (error: TransportAdapterScaffoldGenError, status = 422): NextResponse =>
...
export const createTransportAdapterScaffoldGenRoutes = (
  handler: TransportAdapterScaffoldGenHandler,
