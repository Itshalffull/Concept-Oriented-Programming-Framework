...
// Place at: app/api/article/route.ts
...
import type { ArticleHandler, ArticleError } from './handler.js';
import type { ArticleStorage } from './types.js';

const errorResponse = (error: ArticleError, status = 422): NextResponse =>
