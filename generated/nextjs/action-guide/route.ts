...
import type { ActionGuideHandler, ActionGuideError } from './handler.js';
import type { ActionGuideStorage } from './types.js';

const errorResponse = (error: ActionGuideError, status = 422): NextResponse =>
...
export const createActionGuideRoutes = (
  handler: ActionGuideHandler,
