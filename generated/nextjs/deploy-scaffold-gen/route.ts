...
import type { DeployScaffoldGenHandler, DeployScaffoldGenError } from './handler.js';
import type { DeployScaffoldGenStorage } from './types.js';

const errorResponse = (error: DeployScaffoldGenError, status = 422): NextResponse =>
...
export const createDeployScaffoldGenRoutes = (
  handler: DeployScaffoldGenHandler,
