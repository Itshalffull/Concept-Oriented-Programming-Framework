...
import type { LWWResolutionHandler, LWWResolutionError } from './handler.js';
import type { LWWResolutionStorage } from './types.js';

const errorResponse = (error: LWWResolutionError, status = 422): NextResponse =>
...
export const createLWWResolutionRoutes = (
  handler: LWWResolutionHandler,
