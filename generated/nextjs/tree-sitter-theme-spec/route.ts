...
import type { TreeSitterThemeSpecHandler, TreeSitterThemeSpecError } from './handler.js';
import type { TreeSitterThemeSpecStorage } from './types.js';

const errorResponse = (error: TreeSitterThemeSpecError, status = 422): NextResponse =>
...
export const createTreeSitterThemeSpecRoutes = (
  handler: TreeSitterThemeSpecHandler,
