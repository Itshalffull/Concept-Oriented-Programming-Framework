...
import type { JavaSdkTargetHandler, JavaSdkTargetError } from './handler.js';
import type { JavaSdkTargetStorage } from './types.js';

const errorResponse = (error: JavaSdkTargetError, status = 422): NextResponse =>
...
export const createJavaSdkTargetRoutes = (
  handler: JavaSdkTargetHandler,
