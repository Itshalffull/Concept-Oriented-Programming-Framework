...
import type { SolidAdapterHandler, SolidAdapterError } from './handler.js';
import type { SolidAdapterStorage } from './types.js';

const errorResponse = (error: SolidAdapterError, status = 422): NextResponse =>
...
export const createSolidAdapterRoutes = (
