...
import type { SyncScaffoldGenHandler, SyncScaffoldGenError } from './handler.js';
import type { SyncScaffoldGenStorage } from './types.js';

const errorResponse = (error: SyncScaffoldGenError, status = 422): NextResponse =>
...
export const createSyncScaffoldGenRoutes = (
  handler: SyncScaffoldGenHandler,
