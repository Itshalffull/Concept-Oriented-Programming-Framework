...
// Place at: app/api/slot-source/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { SlotSourceHandler, SlotSourceError } from './handler.js';
import type { SlotSourceStorage } from './types.js';

const errorResponse = (error: SlotSourceError, status = 422): NextResponse =>
...
export const createSlotSourceRoutes = (
  handler: SlotSourceHandler,
