...
// Place at: app/api/slot/route.ts
...
import type { SlotHandler, SlotError } from './handler.js';
import type { SlotStorage } from './types.js';

const errorResponse = (error: SlotError, status = 422): NextResponse =>
