...
import type { WidgetGenReactHandler, WidgetGenReactError } from './handler.js';
import type { WidgetGenReactStorage } from './types.js';

const errorResponse = (error: WidgetGenReactError, status = 422): NextResponse =>
...
export const createWidgetGenReactRoutes = (
  handler: WidgetGenReactHandler,
