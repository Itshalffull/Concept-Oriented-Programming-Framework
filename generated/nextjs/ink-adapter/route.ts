...
// Place at: app/api/ink-adapter/route.ts
...
import type { InkAdapterHandler, InkAdapterError } from './handler.js';
import type { InkAdapterStorage } from './types.js';

const errorResponse = (error: InkAdapterError, status = 422): NextResponse =>
...
export const createInkAdapterRoutes = (
