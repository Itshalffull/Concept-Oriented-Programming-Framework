...
// Place at: app/api/middleware/route.ts
...
import type { MiddlewareHandler, MiddlewareError } from './handler.js';
import type { MiddlewareStorage } from './types.js';

const errorResponse = (error: MiddlewareError, status = 422): NextResponse =>
...
export const createMiddlewareRoutes = (
