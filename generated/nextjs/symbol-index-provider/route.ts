...
import type { SymbolIndexProviderHandler, SymbolIndexProviderError } from './handler.js';
import type { SymbolIndexProviderStorage } from './types.js';

const errorResponse = (error: SymbolIndexProviderError, status = 422): NextResponse =>
...
export const createSymbolIndexProviderRoutes = (
  handler: SymbolIndexProviderHandler,
