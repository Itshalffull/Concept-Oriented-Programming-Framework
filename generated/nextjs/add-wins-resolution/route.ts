...
import type { AddWinsResolutionHandler, AddWinsResolutionError } from './handler.js';
import type { AddWinsResolutionStorage } from './types.js';

const errorResponse = (error: AddWinsResolutionError, status = 422): NextResponse =>
...
export const createAddWinsResolutionRoutes = (
  handler: AddWinsResolutionHandler,
