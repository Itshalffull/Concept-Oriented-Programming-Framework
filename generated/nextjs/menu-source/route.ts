...
// Place at: app/api/menu-source/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { MenuSourceHandler, MenuSourceError } from './handler.js';
import type { MenuSourceStorage } from './types.js';

const errorResponse = (error: MenuSourceError, status = 422): NextResponse =>
...
export const createMenuSourceRoutes = (
  handler: MenuSourceHandler,
