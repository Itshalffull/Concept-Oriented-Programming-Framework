...
// Place at: app/api/spec/route.ts
...
import type { SpecHandler, SpecError } from './handler.js';
import type { SpecStorage } from './types.js';

const errorResponse = (error: SpecError, status = 422): NextResponse =>
