...
import type { WidgetGenGtkHandler, WidgetGenGtkError } from './handler.js';
import type { WidgetGenGtkStorage } from './types.js';

const errorResponse = (error: WidgetGenGtkError, status = 422): NextResponse =>
...
export const createWidgetGenGtkRoutes = (
  handler: WidgetGenGtkHandler,
