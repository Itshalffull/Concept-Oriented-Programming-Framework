...
// Place at: app/api/j-w-t/route.ts
...
import type { JWTHandler, JWTError } from './handler.js';
import type { JWTStorage } from './types.js';

const errorResponse = (error: JWTError, status = 422): NextResponse =>
