// SelectionPipelineDependenceProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/selection-pipeline-dependence-provider/route.ts
...
import type { SelectionPipelineDependenceProviderHandler, SelectionPipelineDependenceProviderError } from './handler.js';
import type { SelectionPipelineDependenceProviderStorage } from './types.js';

const errorResponse = (error: SelectionPipelineDependenceProviderError, status = 422): NextResponse =>
...
export const createSelectionPipelineDependenceProviderRoutes = (
  handler: SelectionPipelineDependenceProviderHandler,
