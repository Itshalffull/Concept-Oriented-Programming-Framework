...
import type { DesktopAdapterHandler, DesktopAdapterError } from './handler.js';
import type { DesktopAdapterStorage } from './types.js';

const errorResponse = (error: DesktopAdapterError, status = 422): NextResponse =>
...
export const createDesktopAdapterRoutes = (
  handler: DesktopAdapterHandler,
