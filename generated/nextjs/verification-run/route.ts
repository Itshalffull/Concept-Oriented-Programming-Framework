...
import type { VerificationRunHandler, VerificationRunError } from './handler.js';
import type { VerificationRunStorage } from './types.js';

const errorResponse = (error: VerificationRunError, status = 422): NextResponse =>
...
export const createVerificationRunRoutes = (
  handler: VerificationRunHandler,
