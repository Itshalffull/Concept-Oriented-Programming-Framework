...
import type { SolidityBuilderHandler, SolidityBuilderError } from './handler.js';
import type { SolidityBuilderStorage } from './types.js';

const errorResponse = (error: SolidityBuilderError, status = 422): NextResponse =>
...
export const createSolidityBuilderRoutes = (
  handler: SolidityBuilderHandler,
