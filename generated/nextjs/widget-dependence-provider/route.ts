// WidgetDependenceProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/widget-dependence-provider/route.ts
...
import type { WidgetDependenceProviderHandler, WidgetDependenceProviderError } from './handler.js';
import type { WidgetDependenceProviderStorage } from './types.js';

const errorResponse = (error: WidgetDependenceProviderError, status = 422): NextResponse =>
...
export const createWidgetDependenceProviderRoutes = (
  handler: WidgetDependenceProviderHandler,
