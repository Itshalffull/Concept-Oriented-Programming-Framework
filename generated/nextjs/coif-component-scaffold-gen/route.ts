// CoifComponentScaffoldGen — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/coif-component-scaffold-gen/route.ts
...
import type { CoifComponentScaffoldGenHandler, CoifComponentScaffoldGenError } from './handler.js';
import type { CoifComponentScaffoldGenStorage } from './types.js';

const errorResponse = (error: CoifComponentScaffoldGenError, status = 422): NextResponse =>
...
export const createCoifComponentScaffoldGenRoutes = (
  handler: CoifComponentScaffoldGenHandler,
