// CircularLayout — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/circular-layout/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { CircularLayoutHandler, CircularLayoutError } from './handler.js';
import type { CircularLayoutStorage } from './types.js';

const errorResponse = (error: CircularLayoutError, status = 422): NextResponse =>
...
export const createCircularLayoutRoutes = (
  handler: CircularLayoutHandler,
