...
import type { PulumiProviderHandler, PulumiProviderError } from './handler.js';
import type { PulumiProviderStorage } from './types.js';

const errorResponse = (error: PulumiProviderError, status = 422): NextResponse =>
...
export const createPulumiProviderRoutes = (
