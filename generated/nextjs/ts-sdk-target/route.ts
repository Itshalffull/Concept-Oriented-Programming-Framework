...
import type { TsSdkTargetHandler, TsSdkTargetError } from './handler.js';
import type { TsSdkTargetStorage } from './types.js';

const errorResponse = (error: TsSdkTargetError, status = 422): NextResponse =>
...
export const createTsSdkTargetRoutes = (
  handler: TsSdkTargetHandler,
