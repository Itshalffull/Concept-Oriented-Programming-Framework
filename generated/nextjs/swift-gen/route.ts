...
// Place at: app/api/swift-gen/route.ts
...
import type { SwiftGenHandler, SwiftGenError } from './handler.js';
import type { SwiftGenStorage } from './types.js';

const errorResponse = (error: SwiftGenError, status = 422): NextResponse =>
...
export const createSwiftGenRoutes = (
