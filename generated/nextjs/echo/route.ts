...
// Place at: app/api/echo/route.ts
...
import type { EchoHandler, EchoError } from './handler.js';
import type { EchoStorage } from './types.js';

const errorResponse = (error: EchoError, status = 422): NextResponse =>
