...
import type { RecursiveMergeHandler, RecursiveMergeError } from './handler.js';
import type { RecursiveMergeStorage } from './types.js';

const errorResponse = (error: RecursiveMergeError, status = 422): NextResponse =>
...
export const createRecursiveMergeRoutes = (
  handler: RecursiveMergeHandler,
