...
import type { TypeScriptGenHandler, TypeScriptGenError } from './handler.js';
import type { TypeScriptGenStorage } from './types.js';

const errorResponse = (error: TypeScriptGenError, status = 422): NextResponse =>
...
export const createTypeScriptGenRoutes = (
