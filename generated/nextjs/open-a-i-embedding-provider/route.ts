// OpenAIEmbeddingProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/open-a-i-embedding-provider/route.ts
...
import type { OpenAIEmbeddingProviderHandler, OpenAIEmbeddingProviderError } from './handler.js';
import type { OpenAIEmbeddingProviderStorage } from './types.js';

const errorResponse = (error: OpenAIEmbeddingProviderError, status = 422): NextResponse =>
...
export const createOpenAIEmbeddingProviderRoutes = (
  handler: OpenAIEmbeddingProviderHandler,
