// WebhookAutomationProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/webhook-automation-provider/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { WebhookAutomationProviderHandler, WebhookAutomationProviderError } from './handler.js';
import type { WebhookAutomationProviderStorage } from './types.js';

const errorResponse = (error: WebhookAutomationProviderError, status = 422): NextResponse =>
...
export const createWebhookAutomationProviderRoutes = (
  handler: WebhookAutomationProviderHandler,
