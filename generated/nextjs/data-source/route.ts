...
// Place at: app/api/data-source/route.ts
...
import type { DataSourceHandler, DataSourceError } from './handler.js';
import type { DataSourceStorage } from './types.js';

const errorResponse = (error: DataSourceError, status = 422): NextResponse =>
...
export const createDataSourceRoutes = (
