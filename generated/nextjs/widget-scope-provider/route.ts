...
import type { WidgetScopeProviderHandler, WidgetScopeProviderError } from './handler.js';
import type { WidgetScopeProviderStorage } from './types.js';

const errorResponse = (error: WidgetScopeProviderError, status = 422): NextResponse =>
...
export const createWidgetScopeProviderRoutes = (
  handler: WidgetScopeProviderHandler,
