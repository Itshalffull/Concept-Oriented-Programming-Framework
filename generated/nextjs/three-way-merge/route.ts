...
import type { ThreeWayMergeHandler, ThreeWayMergeError } from './handler.js';
import type { ThreeWayMergeStorage } from './types.js';

const errorResponse = (error: ThreeWayMergeError, status = 422): NextResponse =>
...
export const createThreeWayMergeRoutes = (
  handler: ThreeWayMergeHandler,
