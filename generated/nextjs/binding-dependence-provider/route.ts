// BindingDependenceProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/binding-dependence-provider/route.ts
...
import type { BindingDependenceProviderHandler, BindingDependenceProviderError } from './handler.js';
import type { BindingDependenceProviderStorage } from './types.js';

const errorResponse = (error: BindingDependenceProviderError, status = 422): NextResponse =>
...
export const createBindingDependenceProviderRoutes = (
  handler: BindingDependenceProviderHandler,
