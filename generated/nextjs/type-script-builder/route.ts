...
import type { TypeScriptBuilderHandler, TypeScriptBuilderError } from './handler.js';
import type { TypeScriptBuilderStorage } from './types.js';

const errorResponse = (error: TypeScriptBuilderError, status = 422): NextResponse =>
...
export const createTypeScriptBuilderRoutes = (
  handler: TypeScriptBuilderHandler,
