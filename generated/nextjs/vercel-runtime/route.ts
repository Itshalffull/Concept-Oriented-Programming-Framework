...
import type { VercelRuntimeHandler, VercelRuntimeError } from './handler.js';
import type { VercelRuntimeStorage } from './types.js';

const errorResponse = (error: VercelRuntimeError, status = 422): NextResponse =>
...
export const createVercelRuntimeRoutes = (
