...
import type { TypeScriptToolchainHandler, TypeScriptToolchainError } from './handler.js';
import type { TypeScriptToolchainStorage } from './types.js';

const errorResponse = (error: TypeScriptToolchainError, status = 422): NextResponse =>
...
export const createTypeScriptToolchainRoutes = (
  handler: TypeScriptToolchainHandler,
