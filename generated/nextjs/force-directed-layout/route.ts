// ForceDirectedLayout — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/force-directed-layout/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { ForceDirectedLayoutHandler, ForceDirectedLayoutError } from './handler.js';
import type { ForceDirectedLayoutStorage } from './types.js';

const errorResponse = (error: ForceDirectedLayoutError, status = 422): NextResponse =>
...
export const createForceDirectedLayoutRoutes = (
  handler: ForceDirectedLayoutHandler,
