...
import type { TreeSitterConceptSpecHandler, TreeSitterConceptSpecError } from './handler.js';
import type { TreeSitterConceptSpecStorage } from './types.js';

const errorResponse = (error: TreeSitterConceptSpecError, status = 422): NextResponse =>
...
export const createTreeSitterConceptSpecRoutes = (
  handler: TreeSitterConceptSpecHandler,
