...
// Place at: app/api/permission/route.ts
...
import type { PermissionHandler, PermissionError } from './handler.js';
import type { PermissionStorage } from './types.js';

const errorResponse = (error: PermissionError, status = 422): NextResponse =>
