...
import type { SemanticMergeHandler, SemanticMergeError } from './handler.js';
import type { SemanticMergeStorage } from './types.js';

const errorResponse = (error: SemanticMergeError, status = 422): NextResponse =>
...
export const createSemanticMergeRoutes = (
  handler: SemanticMergeHandler,
