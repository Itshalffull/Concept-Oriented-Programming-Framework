...
import type { ProcessMetricHandler, ProcessMetricError } from './handler.js';
import type { ProcessMetricStorage } from './types.js';

const errorResponse = (error: ProcessMetricError, status = 422): NextResponse =>
...
export const createProcessMetricRoutes = (
