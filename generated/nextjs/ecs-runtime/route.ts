...
// Place at: app/api/ecs-runtime/route.ts
...
import type { EcsRuntimeHandler, EcsRuntimeError } from './handler.js';
import type { EcsRuntimeStorage } from './types.js';

const errorResponse = (error: EcsRuntimeError, status = 422): NextResponse =>
...
export const createEcsRuntimeRoutes = (
