...
import type { PatienceDiffHandler, PatienceDiffError } from './handler.js';
import type { PatienceDiffStorage } from './types.js';

const errorResponse = (error: PatienceDiffError, status = 422): NextResponse =>
...
export const createPatienceDiffRoutes = (
  handler: PatienceDiffHandler,
