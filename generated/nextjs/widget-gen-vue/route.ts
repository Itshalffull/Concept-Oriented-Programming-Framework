...
import type { WidgetGenVueHandler, WidgetGenVueError } from './handler.js';
import type { WidgetGenVueStorage } from './types.js';

const errorResponse = (error: WidgetGenVueError, status = 422): NextResponse =>
...
export const createWidgetGenVueRoutes = (
  handler: WidgetGenVueHandler,
