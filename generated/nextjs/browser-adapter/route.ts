...
import type { BrowserAdapterHandler, BrowserAdapterError } from './handler.js';
import type { BrowserAdapterStorage } from './types.js';

const errorResponse = (error: BrowserAdapterError, status = 422): NextResponse =>
...
export const createBrowserAdapterRoutes = (
  handler: BrowserAdapterHandler,
