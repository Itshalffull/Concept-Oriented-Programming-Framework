...
// Place at: app/api/schema-gen/route.ts
...
import type { SchemaGenHandler, SchemaGenError } from './handler.js';
import type { SchemaGenStorage } from './types.js';

const errorResponse = (error: SchemaGenError, status = 422): NextResponse =>
