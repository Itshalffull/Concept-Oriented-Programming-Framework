...
import type { WidgetGenWearHandler, WidgetGenWearError } from './handler.js';
import type { WidgetGenWearStorage } from './types.js';

const errorResponse = (error: WidgetGenWearError, status = 422): NextResponse =>
...
export const createWidgetGenWearRoutes = (
  handler: WidgetGenWearHandler,
