...
// Place at: app/api/vue-adapter/route.ts
...
import type { VueAdapterHandler, VueAdapterError } from './handler.js';
import type { VueAdapterStorage } from './types.js';

const errorResponse = (error: VueAdapterError, status = 422): NextResponse =>
...
export const createVueAdapterRoutes = (
