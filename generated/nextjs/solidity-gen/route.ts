...
import type { SolidityGenHandler, SolidityGenError } from './handler.js';
import type { SolidityGenStorage } from './types.js';

const errorResponse = (error: SolidityGenError, status = 422): NextResponse =>
...
export const createSolidityGenRoutes = (
