...
import type { CloudFormationProviderHandler, CloudFormationProviderError } from './handler.js';
import type { CloudFormationProviderStorage } from './types.js';

const errorResponse = (error: CloudFormationProviderError, status = 422): NextResponse =>
...
export const createCloudFormationProviderRoutes = (
