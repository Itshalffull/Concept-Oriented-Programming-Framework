...
// Place at: app/api/gcf-runtime/route.ts
...
import type { GcfRuntimeHandler, GcfRuntimeError } from './handler.js';
import type { GcfRuntimeStorage } from './types.js';

const errorResponse = (error: GcfRuntimeError, status = 422): NextResponse =>
...
export const createGcfRuntimeRoutes = (
