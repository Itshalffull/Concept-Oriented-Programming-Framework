// EntityFieldSource — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/entity-field-source/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { EntityFieldSourceHandler, EntityFieldSourceError } from './handler.js';
import type { EntityFieldSourceStorage } from './types.js';

const errorResponse = (error: EntityFieldSourceError, status = 422): NextResponse =>
...
export const createEntityFieldSourceRoutes = (
  handler: EntityFieldSourceHandler,
