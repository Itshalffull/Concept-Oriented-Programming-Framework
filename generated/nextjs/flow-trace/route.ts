...
// Place at: app/api/flow-trace/route.ts
...
import type { FlowTraceHandler, FlowTraceError } from './handler.js';
import type { FlowTraceStorage } from './types.js';

const errorResponse = (error: FlowTraceError, status = 422): NextResponse =>
...
export const createFlowTraceRoutes = (
