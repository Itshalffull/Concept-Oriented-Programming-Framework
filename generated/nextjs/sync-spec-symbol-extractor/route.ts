// SyncSpecSymbolExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/sync-spec-symbol-extractor/route.ts
...
import type { SyncSpecSymbolExtractorHandler, SyncSpecSymbolExtractorError } from './handler.js';
import type { SyncSpecSymbolExtractorStorage } from './types.js';

const errorResponse = (error: SyncSpecSymbolExtractorError, status = 422): NextResponse =>
...
export const createSyncSpecSymbolExtractorRoutes = (
  handler: SyncSpecSymbolExtractorHandler,
