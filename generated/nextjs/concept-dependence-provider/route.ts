// ConceptDependenceProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/concept-dependence-provider/route.ts
...
import type { ConceptDependenceProviderHandler, ConceptDependenceProviderError } from './handler.js';
import type { ConceptDependenceProviderStorage } from './types.js';

const errorResponse = (error: ConceptDependenceProviderError, status = 422): NextResponse =>
...
export const createConceptDependenceProviderRoutes = (
  handler: ConceptDependenceProviderHandler,
