// TypeScriptScopeProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/type-script-scope-provider/route.ts
...
import type { TypeScriptScopeProviderHandler, TypeScriptScopeProviderError } from './handler.js';
import type { TypeScriptScopeProviderStorage } from './types.js';

const errorResponse = (error: TypeScriptScopeProviderError, status = 422): NextResponse =>
...
export const createTypeScriptScopeProviderRoutes = (
  handler: TypeScriptScopeProviderHandler,
