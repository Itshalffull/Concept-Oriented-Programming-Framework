...
import type { NextjsTargetHandler, NextjsTargetError } from './handler.js';
import type { NextjsTargetStorage } from './types.js';

const errorResponse = (error: NextjsTargetError, status = 422): NextResponse =>
...
export const createNextjsTargetRoutes = (
  handler: NextjsTargetHandler,
