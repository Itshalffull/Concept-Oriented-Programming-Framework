// DatalogAnalysisProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/datalog-analysis-provider/route.ts
...
import type { DatalogAnalysisProviderHandler, DatalogAnalysisProviderError } from './handler.js';
import type { DatalogAnalysisProviderStorage } from './types.js';

const errorResponse = (error: DatalogAnalysisProviderError, status = 422): NextResponse =>
...
export const createDatalogAnalysisProviderRoutes = (
  handler: DatalogAnalysisProviderHandler,
