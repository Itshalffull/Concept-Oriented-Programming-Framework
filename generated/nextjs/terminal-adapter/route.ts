...
import type { TerminalAdapterHandler, TerminalAdapterError } from './handler.js';
import type { TerminalAdapterStorage } from './types.js';

const errorResponse = (error: TerminalAdapterError, status = 422): NextResponse =>
...
export const createTerminalAdapterRoutes = (
  handler: TerminalAdapterHandler,
