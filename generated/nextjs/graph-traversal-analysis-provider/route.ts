// GraphTraversalAnalysisProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/graph-traversal-analysis-provider/route.ts
...
import type { GraphTraversalAnalysisProviderHandler, GraphTraversalAnalysisProviderError } from './handler.js';
import type { GraphTraversalAnalysisProviderStorage } from './types.js';

const errorResponse = (error: GraphTraversalAnalysisProviderError, status = 422): NextResponse =>
...
export const createGraphTraversalAnalysisProviderRoutes = (
  handler: GraphTraversalAnalysisProviderHandler,
