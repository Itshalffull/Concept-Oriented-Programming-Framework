...
import type { WinUIAdapterHandler, WinUIAdapterError } from './handler.js';
import type { WinUIAdapterStorage } from './types.js';

const errorResponse = (error: WinUIAdapterError, status = 422): NextResponse =>
...
export const createWinUIAdapterRoutes = (
