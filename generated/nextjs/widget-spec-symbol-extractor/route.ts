// WidgetSpecSymbolExtractor — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/widget-spec-symbol-extractor/route.ts
...
import type { WidgetSpecSymbolExtractorHandler, WidgetSpecSymbolExtractorError } from './handler.js';
import type { WidgetSpecSymbolExtractorStorage } from './types.js';

const errorResponse = (error: WidgetSpecSymbolExtractorError, status = 422): NextResponse =>
...
export const createWidgetSpecSymbolExtractorRoutes = (
  handler: WidgetSpecSymbolExtractorHandler,
