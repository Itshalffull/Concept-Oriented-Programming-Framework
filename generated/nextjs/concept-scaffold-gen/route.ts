...
import type { ConceptScaffoldGenHandler, ConceptScaffoldGenError } from './handler.js';
import type { ConceptScaffoldGenStorage } from './types.js';

const errorResponse = (error: ConceptScaffoldGenError, status = 422): NextResponse =>
...
export const createConceptScaffoldGenRoutes = (
  handler: ConceptScaffoldGenHandler,
