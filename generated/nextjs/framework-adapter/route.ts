...
import type { FrameworkAdapterHandler, FrameworkAdapterError } from './handler.js';
import type { FrameworkAdapterStorage } from './types.js';

const errorResponse = (error: FrameworkAdapterError, status = 422): NextResponse =>
...
export const createFrameworkAdapterRoutes = (
