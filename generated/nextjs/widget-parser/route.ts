...
import type { WidgetParserHandler, WidgetParserError } from './handler.js';
import type { WidgetParserStorage } from './types.js';

const errorResponse = (error: WidgetParserError, status = 422): NextResponse =>
...
export const createWidgetParserRoutes = (
  handler: WidgetParserHandler,
