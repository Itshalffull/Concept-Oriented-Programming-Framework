...
import type { TreeSitterWidgetSpecHandler, TreeSitterWidgetSpecError } from './handler.js';
import type { TreeSitterWidgetSpecStorage } from './types.js';

const errorResponse = (error: TreeSitterWidgetSpecError, status = 422): NextResponse =>
...
export const createTreeSitterWidgetSpecRoutes = (
  handler: TreeSitterWidgetSpecHandler,
