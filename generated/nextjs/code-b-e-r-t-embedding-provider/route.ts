// CodeBERTEmbeddingProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/code-b-e-r-t-embedding-provider/route.ts
...
import type { CodeBERTEmbeddingProviderHandler, CodeBERTEmbeddingProviderError } from './handler.js';
import type { CodeBERTEmbeddingProviderStorage } from './types.js';

const errorResponse = (error: CodeBERTEmbeddingProviderError, status = 422): NextResponse =>
...
export const createCodeBERTEmbeddingProviderRoutes = (
  handler: CodeBERTEmbeddingProviderHandler,
