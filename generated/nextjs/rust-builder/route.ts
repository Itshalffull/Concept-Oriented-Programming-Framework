...
import type { RustBuilderHandler, RustBuilderError } from './handler.js';
import type { RustBuilderStorage } from './types.js';

const errorResponse = (error: RustBuilderError, status = 422): NextResponse =>
...
export const createRustBuilderRoutes = (
  handler: RustBuilderHandler,
