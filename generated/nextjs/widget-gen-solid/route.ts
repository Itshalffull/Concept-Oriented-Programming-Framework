...
import type { WidgetGenSolidHandler, WidgetGenSolidError } from './handler.js';
import type { WidgetGenSolidStorage } from './types.js';

const errorResponse = (error: WidgetGenSolidError, status = 422): NextResponse =>
...
export const createWidgetGenSolidRoutes = (
  handler: WidgetGenSolidHandler,
