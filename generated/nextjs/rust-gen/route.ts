...
// Place at: app/api/rust-gen/route.ts
...
import type { RustGenHandler, RustGenError } from './handler.js';
import type { RustGenStorage } from './types.js';

const errorResponse = (error: RustGenError, status = 422): NextResponse =>
...
export const createRustGenRoutes = (
