...
import type { TreeSitterJsonHandler, TreeSitterJsonError } from './handler.js';
import type { TreeSitterJsonStorage } from './types.js';

const errorResponse = (error: TreeSitterJsonError, status = 422): NextResponse =>
...
export const createTreeSitterJsonRoutes = (
  handler: TreeSitterJsonHandler,
