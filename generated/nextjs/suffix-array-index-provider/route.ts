// SuffixArrayIndexProvider — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/suffix-array-index-provider/route.ts
...
import type { SuffixArrayIndexProviderHandler, SuffixArrayIndexProviderError } from './handler.js';
import type { SuffixArrayIndexProviderStorage } from './types.js';

const errorResponse = (error: SuffixArrayIndexProviderError, status = 422): NextResponse =>
...
export const createSuffixArrayIndexProviderRoutes = (
  handler: SuffixArrayIndexProviderHandler,
