// WidgetEmbedSource — route.ts
// Generated by NextjsGen. Do not edit manually.
// Uses fp-ts for purely functional, composable concept implementations.

// Next.js App Router Route Handler — maps HTTP to concept actions
// Place at: app/api/widget-embed-source/route.ts

import { NextRequest, NextResponse } from 'next/server';
import * as E from 'fp-ts/Either';
import { pipe } from 'fp-ts/function';

import type { WidgetEmbedSourceHandler, WidgetEmbedSourceError } from './handler.js';
import type { WidgetEmbedSourceStorage } from './types.js';

const errorResponse = (error: WidgetEmbedSourceError, status = 422): NextResponse =>
...
export const createWidgetEmbedSourceRoutes = (
  handler: WidgetEmbedSourceHandler,
