...
// Place at: app/api/git-ops/route.ts
...
import type { GitOpsHandler, GitOpsError } from './handler.js';
import type { GitOpsStorage } from './types.js';

const errorResponse = (error: GitOpsError, status = 422): NextResponse =>
...
export const createGitOpsRoutes = (
