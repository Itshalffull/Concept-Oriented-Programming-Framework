...
import type { SdkHandler, SdkError } from './handler.js';
import type { SdkStorage } from './types.js';

const errorResponse = (error: SdkError, status = 422): NextResponse =>
