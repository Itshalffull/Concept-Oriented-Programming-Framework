...
import type { WatchAdapterHandler, WatchAdapterError } from './handler.js';
import type { WatchAdapterStorage } from './types.js';

const errorResponse = (error: WatchAdapterError, status = 422): NextResponse =>
...
export const createWatchAdapterRoutes = (
  handler: WatchAdapterHandler,
