...
contract RustBuilderTest is Test {
    ...
    function test_invariant_1() public {
        ...
        // --- Assertions ---
        // runTests(build: r, toolchainPath: "/usr/local/bin/rustc", invocation: { command: "cargo test", args: ["--", "--format=json"], outputFormat: "cargo-test-json", configFile: "Cargo.toml", env: null }, testType: "unit") -> ok
        // target.runTests(r, "/usr/local/bin/rustc", /* struct { command: "cargo test", args: /* ["--", "--format=json"] */, outputFormat: "cargo-test-json", configFile: "Cargo.toml", env: null } */, "unit");
        // TODO: Assert ok variant
    }
