...
import "../src/SvelteAdapter.sol";

/// @title SvelteAdapter Conformance Tests
/// @notice Generated from concept invariants
contract SvelteAdapterTest is Test {
    SvelteAdapter public target;

    function setUp() public {
        target = new SvelteAdapter();
    }
