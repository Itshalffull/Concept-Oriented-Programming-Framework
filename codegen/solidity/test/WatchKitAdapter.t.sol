...
import "../src/WatchKitAdapter.sol";

/// @title WatchKitAdapter Conformance Tests
/// @notice Generated from concept invariants
contract WatchKitAdapterTest is Test {
    WatchKitAdapter public target;

    function setUp() public {
        target = new WatchKitAdapter();
    }
