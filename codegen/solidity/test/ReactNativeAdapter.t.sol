...
import "../src/ReactNativeAdapter.sol";

/// @title ReactNativeAdapter Conformance Tests
/// @notice Generated from concept invariants
contract ReactNativeAdapterTest is Test {
    ReactNativeAdapter public target;

    function setUp() public {
        target = new ReactNativeAdapter();
    }
