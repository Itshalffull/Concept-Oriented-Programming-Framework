...
import "../src/VanillaAdapter.sol";

/// @title VanillaAdapter Conformance Tests
/// @notice Generated from concept invariants
contract VanillaAdapterTest is Test {
    VanillaAdapter public target;

    function setUp() public {
        target = new VanillaAdapter();
    }
