...
/// @title VueAdapter
/// @notice Render adapter for the Vue.js framework.
///         Normalizes Clef widget props into Vue-compatible form.
...
contract VueAdapter {
    ...
    /// @notice Normalize widget props for the Vue.js framework.
    function normalize(bytes32 adapter, string memory props) external returns (NormalizeOkResult memory) {
        ...
        string memory normalized = string(abi.encodePacked("vue:", props));
