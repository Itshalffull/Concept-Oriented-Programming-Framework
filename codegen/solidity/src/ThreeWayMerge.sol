...
/// @title ThreeWayMerge
/// @notice Merge provider plugin using standard three-way merge (simplified on-chain).
///         Resolves clean merges via three-way hash comparison; reverts on true conflicts.
contract ThreeWayMerge {
    ...
    /// @notice Executes a three-way merge on three content versions.
