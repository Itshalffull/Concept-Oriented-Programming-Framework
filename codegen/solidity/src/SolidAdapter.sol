...
/// @title SolidAdapter
/// @notice Render adapter for the SolidJS framework.
///         Normalizes Clef widget props into SolidJS-compatible form.
/// @dev Skeleton contract — implement action bodies

contract SolidAdapter {
    ...
    /// @notice Normalize widget props for the SolidJS framework.
    function normalize(bytes32 adapter, string memory props) external returns (NormalizeOkResult memory) {
        ...
        string memory normalized = string(abi.encodePacked("solidjs:", props));
