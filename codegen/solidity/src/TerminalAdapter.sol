...
/// @notice Platform adapter for CLI / terminal environments.
///         Normalizes Clef widget props into terminal-compatible form.
/// @dev Skeleton contract — implement action bodies

contract TerminalAdapter {
    ...
    /// @notice Normalize widget props for the terminal platform.
    function normalize(bytes32 adapter, string memory props) external returns (NormalizeOkResult memory) {
        ...
        string memory normalized = string(abi.encodePacked("terminal:", props));
