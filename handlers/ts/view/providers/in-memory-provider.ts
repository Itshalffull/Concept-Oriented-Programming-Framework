...
// ─── FilterNode (mirrors FilterSpec handler and clef-base/lib/filter-evaluator) ───
...
// ─── SortKey (mirrors SortSpec handler) ──────────────────────────────────────
...
function evaluateFilterNode(node: FilterNode, row: Record<string, unknown>): boolean {
  switch (node.type) {
