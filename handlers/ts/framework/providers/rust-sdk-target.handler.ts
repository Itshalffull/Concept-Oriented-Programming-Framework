// @clef-handler style=functional concept=RustSdkTarget
...
function generateCargoToml(packageName: string): string {
  ...
  return [
    ...
    'version = "0.1.0"',
    'edition = "2021"',
    'description = "Auto-generated Rust SDK client — Clef Clef Bind"',
    '',
    '[dependencies]',
...
function generateLibRs(projections: ProjectionEntry[]): string {
  const lines: string[] = [
    '// Auto-generated by Clef Clef Bind — rust-sdk target',
...
const _handler: FunctionalConceptHandler = {
  ...
  generate(input: Record<string, unknown>) {
    ...
    const packageName = (config.packageName as string) || 'clef-sdk';
