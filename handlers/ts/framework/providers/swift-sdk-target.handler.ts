// @clef-handler style=functional concept=SwiftSdkTarget
...
const _handler: FunctionalConceptHandler = {
  ...
  generate(input: Record<string, unknown>) {
    ...
    if (projection && typeof projection.conceptManifest === 'string') {
      ...
      // Plain projection key — generate stub Swift file
      files.push({ path: `Sources/${projectionRaw}/stub.swift`, content: `// Auto-generated Swift SDK stub for projection: ${projectionRaw}\n` });
    }
