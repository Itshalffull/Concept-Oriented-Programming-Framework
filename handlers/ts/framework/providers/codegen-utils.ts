...
export function generateFileHeader(target: string, conceptName: string): string {
  return `// Auto-generated by Clef Clef Bind — ${target} target\n// Concept: ${conceptName}\n// Do not edit manually; regenerate with: clef interface generate\n`;
}

export function generateMarkdownFileHeader(target: string, conceptName: string): string {
  return [
    `<!-- Auto-generated by Clef Clef Bind — ${target} target -->`,
    `<!-- Concept: ${conceptName} -->`,
    `<!-- Do not edit manually; regenerate with: clef interface generate -->`,
    '',
  ].join('\n');
