...
const deployPlanHandlerFunctional: FunctionalConceptHandler = {
...
export const deployPlanHandler = wrapFunctional(deployPlanHandlerFunctional);
/** The raw functional handler returning StorageProgram. */
export { deployPlanHandlerFunctional };
