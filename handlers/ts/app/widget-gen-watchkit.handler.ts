// WidgetGenWatchKit — WatchKit WKInterfaceController classes
// Uses the RenderProgram pipeline: parses widget AST -> builds instructions -> interprets to watchkit code.
...
export const widgetGenWatchKitHandler: ConceptHandler = {
  ...
  async generate(input: Record<string, unknown>, storage: ConceptStorage) {
    ...
    // Interpret instructions into watchkit code
    const { output, trace } = interpretWatchKit(built.instructions, componentName);
