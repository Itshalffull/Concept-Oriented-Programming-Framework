...
const ecsRuntimeHandlerFunctional: FunctionalConceptHandler = {
...
export const ecsRuntimeHandler = wrapFunctional(ecsRuntimeHandlerFunctional);
/** The raw functional handler returning StorageProgram. */
export { ecsRuntimeHandlerFunctional };
