...
const widgetGenHandlerFunctional: FunctionalConceptHandler = {
...
export const widgetGenHandler = wrapFunctional(widgetGenHandlerFunctional);
/** The raw functional handler returning StorageProgram. */
export { widgetGenHandlerFunctional };
