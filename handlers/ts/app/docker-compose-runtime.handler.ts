...
const dockerComposeRuntimeHandlerFunctional: FunctionalConceptHandler = {
...
export const dockerComposeRuntimeHandler = wrapFunctional(dockerComposeRuntimeHandlerFunctional);
/** The raw functional handler returning StorageProgram. */
export { dockerComposeRuntimeHandlerFunctional };
