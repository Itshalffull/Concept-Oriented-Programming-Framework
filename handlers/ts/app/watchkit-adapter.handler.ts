...
const watchKitAdapterHandlerFunctional: FunctionalConceptHandler = {
...
export const watchKitAdapterHandler = wrapFunctional(watchKitAdapterHandlerFunctional);
/** The raw functional handler returning StorageProgram. */
export { watchKitAdapterHandlerFunctional };
